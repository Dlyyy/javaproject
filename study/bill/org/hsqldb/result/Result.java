...
public class Result
{
    ...
    throws IOException
  {
    ...
    case 11: 
      ...
      localResult.databaseName = paramRowInputBinary.readString();
      localResult.mainString = paramRowInputBinary.readString();
      localResult.generateKeys = paramRowInputBinary.readInt();
      break;
    case 1: 
      localResult.updateCount = paramRowInputBinary.readInt();
      break;
  ...
  {
    this.navigator.add(paramArrayOfObject);
  }
  ...
  public static Result newConnectionAcknowledgeResponse(Session paramSession)
  {
    Result localResult = newResult(11);
    localResult.sessionID = paramSession.getId();
    localResult.databaseID = paramSession.getDatabase().getDatabaseID();
    localResult.databaseName = paramSession.getDatabase().getNameString();
    localResult.mainString = paramSession.getDatabase().getProperties().getClientPropertiesAsString();
    localResult.generateKeys = paramSession.getRandomId();
    return localResult;
  }
  ...
  public static Result newCancelRequest(long paramLong, String paramString)
  {
    Result localResult = newResult(5);
    localResult.statementID = paramLong;
    localResult.mainString = paramString;
    return localResult;
  }
  ...
  public static Result newErrorResult(Throwable paramThrowable, String paramString)
  {
    ...
    else if ((paramThrowable instanceof Throwable))
    {
    ...
    {
      localResult.exception = Error.error(458);
      localResult.mainString = localResult.exception.getMessage();
      localResult.subString = localResult.exception.getSQLState();
      localResult.errorCode = localResult.exception.getErrorCode();
    }
    ...
    throws IOException
  {
    ...
    case 11: 
      ...
      paramRowOutputInterface.writeString(this.databaseName);
      paramRowOutputInterface.writeString(this.mainString);
      paramRowOutputInterface.writeInt(this.generateKeys);
      break;
    case 1: 
      paramRowOutputInterface.writeInt(this.updateCount);
      break;
    ...
    paramRowOutputInterface.writeSize(paramRowOutputInterface.size() - i);
  ...
  {
    Object[] arrayOfObject = initialiseNavigator().getNext();
  ...
  public void setSessionRandomID(int paramInt)
  {
    this.generateKeys = paramInt;
  }
  ...
  public void addRows(String[] paramArrayOfString)
  {
    ...
    for (int i = 0; i < paramArrayOfString.length; i++)
    {
      ...
      initialiseNavigator().add(arrayOfString);
    }
  }
  ...
  public void addRow(String[] paramArrayOfString)
  {
    ...
    initialiseNavigator().add(paramArrayOfString);
  }
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\result\Result.class
