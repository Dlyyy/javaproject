...
public final class Right
{
  ...
  public void addNewColumn(HsqlNameManager.HsqlName paramHsqlName)
  {
    if (this.selectColumnSet != null) {
      this.selectColumnSet.add(paramHsqlName);
    }
    if (this.insertColumnSet != null) {
      this.insertColumnSet.add(paramHsqlName);
    }
    if (this.updateColumnSet != null) {
      this.updateColumnSet.add(paramHsqlName);
    }
    if (this.referencesColumnSet != null) {
      this.referencesColumnSet.add(paramHsqlName);
    }
    if (this.triggerColumnSet != null) {
      this.triggerColumnSet.add(paramHsqlName);
    }
  }
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\rights\Right.class
