...
public final class UserManager
{
  ...
  public User createUser(Session paramSession, HsqlNameManager.HsqlName paramHsqlName, String paramString, boolean paramBoolean)
  {
    ...
    if (paramSession == null) {
      ...
      try
      {
        setPassword(paramSession, localUser, paramString, paramBoolean);
      }
    ...
    this.userList.add(paramHsqlName.name, localUser);
    return localUser;
  }
  ...
  public boolean checkComplexity(Session paramSession, String paramString)
  {
    ...
    Result localResult = this.pwCheckFunction.invoke(paramSession, new Object[] { paramString }, null, true);
  ...
  public void createFirstUser(String paramString1, String paramString2)
  {
    ...
    User localUser = createUser(null, localHsqlName, paramString2, false);
  ...
  public User getUser(String paramString1, String paramString2)
  {
    ...
    Result localResult = this.extAuthenticationFunction.invokeJavaMethodDirect(new String[] { this.granteeManager.database.getNameString(), paramString1, paramString2 });
    ...
    if (localUser == null)
    {
      ...
      localUser = createUser(null, localHsqlName, "", false);
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\rights\UserManager.class
