  ...
  extends HsqlProperties
{
  ...
  public boolean load()
  {
    ...
    i = str.substring(0, 2).compareTo("2.3.4");
    if (i > 0) {
      throw Error.error(453);
    }
    return true;
  ...
  public void save()
  {
    ...
    try
    {
      ...
      localHsqlProperties.setProperty("version", "2.3.4");
      localHsqlProperties.setProperty("tx_timestamp", Long.toString(this.database.logger.getFilesTimestamp()));
  ...
  public String getStringPropertyDefault(String paramString)
  {
    Object[] arrayOfObject = (Object[])dbMeta.get(paramString);
    if (arrayOfObject == null) {
      throw Error.error(5555, paramString);
    }
    return (String)arrayOfObject[4];
  }
  ...
  {
    String str = getProperty("hsqldb.cache_version", "2.3.4");
  ...
  static
  {
    ...
    textMeta.put("textdb.qc", HsqlProperties.getMeta("textdb.qc", 2, "\""));
    ...
    dbMeta.put("hsqldb.digest", HsqlProperties.getMeta("hsqldb.digest", 2, "MD5"));
    dbMeta.put("sql.live_object", HsqlProperties.getMeta("sql.live_object", 2, false));
    ...
    dbMeta.put("sql.char_literal", HsqlProperties.getMeta("sql.char_literal", 2, true));
    ...
    dbMeta.put("hsqldb.files_space", HsqlProperties.getMeta("hsqldb.files_space", 2, 0, new int[] { 0, 1, 2, 4, 8, 16, 32, 64 }));
    ...
    dbMeta.put("hsqldb.min_reuse", HsqlProperties.getMeta("hsqldb.min_reuse", 2, 0, 0, 1048576));
  }
}


/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\persist\HsqlDatabaseProperties.class
