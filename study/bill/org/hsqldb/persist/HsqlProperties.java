...
public class HsqlProperties
{
    ...
    throws Exception
  {
    ...
    this.fa.removeElement(paramString);
    ...
    String str = "HSQL Database Engine 2.3.4";
    this.stringProps.store(localOutputStream, str);
  ...
  public static Object[] getMeta(String paramString, int paramInt)
  {
    Object[] arrayOfObject = new Object[9];
    arrayOfObject[0] = paramString;
    arrayOfObject[1] = ValuePool.getInt(paramInt);
    arrayOfObject[2] = "Long";
  ...
  public static String validateProperty(String paramString1, String paramString2, Object[] paramArrayOfObject)
  {
    ...
    if (paramArrayOfObject[2].equals("Long")) {
      return null;
    }
    if (paramArrayOfObject[2].equals("Integer"))
    {
      ...
      {
        return "invalid integer value for property: " + paramString1;
      }
      return null;
    }
    return null;
  ...
  public int getPropertyWithinRange(String paramString, int paramInt)
  {
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\persist\HsqlProperties.class
