  ...
  implements RandomAccessInterface
{
  ...
  public RAFileHybrid(Database paramDatabase, String paramString, boolean paramBoolean)
    throws IOException
  {
    ...
    throws IOException
  {
    ...
    if ((this.preNio) && (this.initialMaxLength <= paramLong)) {
      try
      {
        this.store = new RAFileNIO(this.database.logger, this.fileName, this.isReadOnly, paramLong, this.database.logger.propNioMaxSize);
        this.store.seek(l);
        this.preNio = false;
        this.isNio = true;
        return;
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\persist\RAFileHybrid.class
