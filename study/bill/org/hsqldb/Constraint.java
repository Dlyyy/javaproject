  ...
  implements SchemaObject
{
  ...
  boolean hasColumnOnly(int paramInt)
  {
    ...
    case 1: 
      return false;
    case 0: 
      return (this.core.refCols.length == 1) && (this.core.refCols[0] == paramInt);
    }
  ...
  boolean hasColumnPlus(int paramInt)
  {
    ...
    case 0: 
      return (this.core.refCols.length != 1) && (ArrayUtil.find(this.core.refCols, paramInt) != -1);
    }
    throw Error.runtimeError(201, "Constraint");
  }
  ...
  void checkCheckConstraint(Session paramSession, Table paramTable, Object[] paramArrayOfObject)
  {
    ...
    localRangeIteratorBase.setCurrent(null);
    if (bool)
    {
  ...
  RowIterator findUniqueRows(Session paramSession, Object[] paramArrayOfObject)
  {
    if ((paramArrayOfObject == null) || (ArrayUtil.hasNull(paramArrayOfObject, this.core.mainCols))) {
      return this.core.mainIndex.emptyIterator();
    }
    PersistentStore localPersistentStore = this.core.mainTable.getRowStore(paramSession);
    return this.core.mainIndex.findFirstRow(paramSession, localPersistentStore, paramArrayOfObject, this.core.mainCols);
  }
  ...
  private Expression getNewCheckExpression(Session paramSession)
  {
    ...
    Scanner localScanner = new Scanner(paramSession, str);
    ParserDQL localParserDQL = new ParserDQL(paramSession, localScanner, null);
    localParserDQL.compileContext.setNextRangeVarIndex(0);
    localParserDQL.read();
  ...
  void checkCheckConstraint(Session paramSession, Table paramTable)
  {
    ...
    {
      Expression localExpression = getNewCheckExpression(paramSession);
      QuerySpecification localQuerySpecification = Expression.getCheckSelect(paramSession, paramTable, localExpression);
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\Constraint.class
