...
public class SessionManager
{
  ...
  public Session getSysSessionForScript(Database paramDatabase)
  {
    ...
    localSession.setCurrentSchemaHsqlName(paramDatabase.schemaManager.defaultSchemaHsqlName);
  ...
  public synchronized Session newSysSession(HsqlNameManager.HsqlName paramHsqlName, User paramUser)
  {
  ...
  public synchronized boolean isUserActive(String paramString)
  {
    ...
    for (int i = 0; localIterator.hasNext(); i++)
    {
      ...
      if ((!localSession.isClosed()) && (paramString.equals(localSession.getUser().getName().getNameString()))) {
        return true;
      }
    }
    return false;
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\SessionManager.class
