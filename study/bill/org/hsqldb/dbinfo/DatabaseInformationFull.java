  ...
  extends DatabaseInformationMain
{
  ...
  protected Table generateTable(Session paramSession, PersistentStore paramPersistentStore, int paramInt)
  {
    ...
    case 19: 
      return SYSTEM_INDEXSTATS(paramSession, paramPersistentStore);
    case 22: 
    ...
    case 25: 
      return SYSTEM_SYNONYMS(paramSession, paramPersistentStore);
    case 23: 
  ...
  Table SYSTEM_CACHEINFO(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable1 == null)
    {
      ...
      addColumn(localTable1, "FILE_LOST_BYTES", CARDINAL_NUMBER);
    ...
    while (localIterator2.hasNext())
    {
      ...
      if (localTable2.isText())
      {
        localDataFileCache = null;
    ...
    {
      localDataFileCache = this.database.logger.getCache();
      localHashSet.add(localDataFileCache);
    }
    ...
    while (localIterator1.hasNext())
    {
      ...
      arrayOfObject[5] = ValuePool.getLong(localDataFileCache.getLostBlockSize());
      arrayOfObject[6] = ValuePool.getLong(localDataFileCache.getFileFreePos());
  ...
  Table SYSTEM_PROPERTIES(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      HsqlNameManager.HsqlName localHsqlName = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[20].name, false, 20);
  ...
  Table SYSTEM_SESSIONINFO(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      localObject = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[21].name, false, 20);
  ...
  {
    Table localTable = this.sysTables[22];
    if (localTable == null)
    {
      localTable = createBlankTable(sysTableHsqlNames[22]);
      ...
      HsqlNameManager.HsqlName localHsqlName1 = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[22].name, false, 20);
    ...
    for (int i = 0; i < arrayOfSession1.length; i++) {
      if (!arrayOfSession1[i].isClosed())
      {
        ...
        arrayOfObject[3] = (localSession.isAdmin() ? Boolean.TRUE : Boolean.FALSE);
        arrayOfObject[4] = Boolean.valueOf(localSession.sessionContext.isAutoCommit.booleanValue());
        ...
        arrayOfObject[8] = (localSession.isInMidTransaction() ? Boolean.TRUE : Boolean.FALSE);
  ...
  Table SYSTEM_SYNONYMS(Session paramSession, PersistentStore paramPersistentStore)
  {
    Table localTable = this.sysTables[25];
    if (localTable == null)
    {
      localTable = createBlankTable(sysTableHsqlNames[25]);
      addColumn(localTable, "SYNONYM_CATALOG", SQL_IDENTIFIER);
      addColumn(localTable, "SYNONYM_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable, "SYNONYM_NAME", SQL_IDENTIFIER);
      addColumn(localTable, "OBJECT_CATALOG", SQL_IDENTIFIER);
      addColumn(localTable, "OBJECT_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable, "OBJECT_NAME", SQL_IDENTIFIER);
      addColumn(localTable, "OBJECT_TYPE", SQL_IDENTIFIER);
    ...
    Iterator localIterator = this.database.schemaManager.databaseObjectIterator(29);
    while (localIterator.hasNext())
    {
      ReferenceObject localReferenceObject = (ReferenceObject)localIterator.next();
      Object[] arrayOfObject = localTable.getEmptyRowData();
      arrayOfObject[0] = this.database.getCatalogName().name;
      arrayOfObject[1] = localReferenceObject.getSchemaName().name;
      arrayOfObject[2] = localReferenceObject.getName().name;
      arrayOfObject[3] = this.database.getCatalogName().name;
      arrayOfObject[4] = localReferenceObject.getTarget().schema.name;
      arrayOfObject[5] = localReferenceObject.getTarget().name;
      switch (localReferenceObject.getTarget().type)
      {
      case 3: 
        arrayOfObject[6] = "TABLE";
        break;
      case 4: 
        arrayOfObject[6] = "VIEW";
        break;
      case 7: 
        arrayOfObject[6] = "SEQUENCE";
        break;
      case 18: 
        arrayOfObject[6] = "ROUTINE";
        break;
      case 16: 
        arrayOfObject[6] = "FUNCTION";
        break;
      case 17: 
        arrayOfObject[6] = "PROCEDURE";
      }
      localTable.insertSys(paramSession, paramPersistentStore, arrayOfObject);
    }
    return localTable;
  ...
  {
    Table localTable1 = this.sysTables[24];
    if (localTable1 == null)
    {
      localTable1 = createBlankTable(sysTableHsqlNames[24]);
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localTable2.isText())
      {
        ...
        if (localTextCache != null)
        {
          ...
          arrayOfObject[9] = (localTextFileSettings.ignoreFirst ? Boolean.TRUE : Boolean.FALSE);
          arrayOfObject[10] = (localTextFileSettings.isQuoted ? Boolean.TRUE : Boolean.FALSE);
          arrayOfObject[11] = (localTextFileSettings.isAllQuoted ? Boolean.TRUE : Boolean.FALSE);
  ...
  {
    Table localTable1 = this.sysTables[23];
    if (localTable1 == null)
    {
      localTable1 = createBlankTable(sysTableHsqlNames[23]);
      addColumn(localTable1, "TABLE_CATALOG", SQL_IDENTIFIER);
      addColumn(localTable1, "TABLE_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable1, "TABLE_NAME", SQL_IDENTIFIER);
      addColumn(localTable1, "TABLE_TYPE", SQL_IDENTIFIER);
      addColumn(localTable1, "CARDINALITY", CARDINAL_NUMBER);
      addColumn(localTable1, "SPACE_ID", CARDINAL_NUMBER);
      addColumn(localTable1, "USED_SPACE", CARDINAL_NUMBER);
      addColumn(localTable1, "ALLOCATED_SPACE", CARDINAL_NUMBER);
      addColumn(localTable1, "USED_MEMORY", CARDINAL_NUMBER);
      localObject1 = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[23].name, false, 20);
      localTable1.createPrimaryKeyConstraint((HsqlNameManager.HsqlName)localObject1, new int[] { 0, 1, 2 }, false);
      return localTable1;
    }
    if (!paramSession.isAdmin()) {
      return localTable1;
    }
    DataSpaceManager localDataSpaceManager = null;
    DirectoryBlockCachedObject[] arrayOfDirectoryBlockCachedObject = new DirectoryBlockCachedObject[0];
    int i = this.database.logger.getDataFileScale();
    int j = 1048576 * i / 16;
    boolean bool = this.database.logger.hasCache();
    Object localObject2;
    if (bool)
    {
      localObject2 = this.database.logger.getCache();
      localDataSpaceManager = ((DataFileCache)localObject2).spaceManager;
      arrayOfDirectoryBlockCachedObject = ((DataFileCache)localObject2).spaceManager.getDirectoryList();
      i = ((DataFileCache)localObject2).getDataFileScale();
      j = localDataSpaceManager.getFileBlockSize();
    }
    Object localObject1 = allTables();
    Object[] arrayOfObject;
    while (((Iterator)localObject1).hasNext())
    {
      Table localTable2 = (Table)((Iterator)localObject1).next();
      arrayOfObject = localTable1.getEmptyRowData();
      arrayOfObject[0] = this.database.getCatalogName().name;
      arrayOfObject[1] = localTable2.getSchemaName().name;
      arrayOfObject[2] = localTable2.getName().name;
      arrayOfObject[3] = localTable2.getTableTypeString();
      ...
      localObject2 = localTable2.getRowStore(paramSession);
      arrayOfObject[4] = Long.valueOf(((PersistentStore)localObject2).elementCount());
      if (localTable2.isCached())
      {
        int k = localTable2.getSpaceID();
        arrayOfObject[5] = Long.valueOf(k);
        arrayOfObject[7] = null;
        arrayOfObject[6] = null;
        arrayOfObject[8] = null;
        if ((bool) && (localDataSpaceManager.isMultiSpace()) && (k != 7))
        {
          l2 = 0L;
          l3 = 0L;
          for (int m = 0; m < arrayOfDirectoryBlockCachedObject.length; m++)
          {
            int[] arrayOfInt1 = arrayOfDirectoryBlockCachedObject[m].getTableIdArray();
            char[] arrayOfChar1 = arrayOfDirectoryBlockCachedObject[m].getFreeSpaceArray();
            for (int i1 = 0; i1 < arrayOfInt1.length; i1++) {
              if (arrayOfInt1[i1] == k)
              {
                l2 += j;
                l3 += j - arrayOfChar1[i1] * i;
              }
            }
          }
          if (l2 > 0L)
          {
            TableSpaceManager localTableSpaceManager = ((PersistentStore)localObject2).getSpaceManager();
            l3 -= localTableSpaceManager.getLostBlocksSize();
          }
    ...
    long l3 = 0L;
    long l4 = 0L;
    for (int n = 0; n < arrayOfDirectoryBlockCachedObject.length; n++)
    {
      int[] arrayOfInt2 = arrayOfDirectoryBlockCachedObject[n].getTableIdArray();
      char[] arrayOfChar2 = arrayOfDirectoryBlockCachedObject[n].getFreeSpaceArray();
      int[] arrayOfInt3 = arrayOfDirectoryBlockCachedObject[n].getBitmapAddressArray();
      for (int i2 = 0; i2 < arrayOfInt2.length; i2++) {
        if (arrayOfInt2[i2] == 7)
        {
          l1 += j;
          l2 += j - arrayOfChar2[i2] * i;
        }
        else if ((arrayOfInt2[i2] == 0) && (arrayOfInt3[i2] != 0))
        {
          l3 += j;
        }
        else if (arrayOfInt2[i2] == 1)
        {
          l4 += j;
        }
      }
    ...
    {
      arrayOfObject = localTable1.getEmptyRowData();
      arrayOfObject[2] = "UNUSED_SPACE";
      arrayOfObject[7] = Long.valueOf(l3);
      arrayOfObject[6] = Long.valueOf(0L);
      arrayOfObject[5] = Long.valueOf(0L);
      localTable1.insertSys(paramSession, paramPersistentStore, arrayOfObject);
      arrayOfObject = localTable1.getEmptyRowData();
      arrayOfObject[2] = "COMMON_SPACE";
      arrayOfObject[7] = Long.valueOf(l1);
      arrayOfObject[6] = Long.valueOf(l2);
      arrayOfObject[5] = Long.valueOf(7L);
      localTable1.insertSys(paramSession, paramPersistentStore, arrayOfObject);
      arrayOfObject = localTable1.getEmptyRowData();
      arrayOfObject[2] = "SYSTEM_SPACE";
      arrayOfObject[7] = Long.valueOf(l4);
      arrayOfObject[6] = Long.valueOf(l4);
      arrayOfObject[5] = Long.valueOf(1L);
      localTable1.insertSys(paramSession, paramPersistentStore, arrayOfObject);
    }
    return localTable1;
  }
  
  final Table SYSTEM_INDEXSTATS(Session paramSession, PersistentStore paramPersistentStore)
  {
    Table localTable1 = this.sysTables[19];
    Object localObject;
    if (localTable1 == null)
    {
      localTable1 = createBlankTable(sysTableHsqlNames[19]);
      addColumn(localTable1, "TABLE_CATALOG", SQL_IDENTIFIER);
      addColumn(localTable1, "TABLE_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable1, "TABLE_NAME", SQL_IDENTIFIER);
      addColumn(localTable1, "TABLE_TYPE", SQL_IDENTIFIER);
      ...
      addColumn(localTable1, "CARDINALITY", CARDINAL_NUMBER);
      addColumn(localTable1, "ALLOCATED_ROWS", CARDINAL_NUMBER);
      addColumn(localTable1, "USED_SPACE", CARDINAL_NUMBER);
      addColumn(localTable1, "ALLOCATED_SPACE", CARDINAL_NUMBER);
      addColumn(localTable1, "SPACE_ID", CARDINAL_NUMBER);
      addColumn(localTable1, "BASE_SPACE", CARDINAL_NUMBER);
      localObject = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[19].name, false, 20);
      localTable1.createPrimaryKeyConstraint((HsqlNameManager.HsqlName)localObject, new int[] { 0, 1, 2, 4 }, false);
      return localTable1;
    }
    Iterator localIterator = this.database.schemaManager.databaseObjectIterator(3);
    while (localIterator.hasNext())
    {
      ...
      if ((!localTable2.isView()) && (isAccessibleTable(paramSession, localTable2)))
      {
        ...
        String str3 = localTable2.getTableTypeString();
        int i = localTable2.getIndexCount();
        for (int j = 0; j < i; j++)
        {
          Index localIndex = localTable2.getIndex(j);
          String str4 = localIndex.getName().name;
          Object[] arrayOfObject = localTable1.getEmptyRowData();
  ...
  Table ADMINISTRABLE_ROLE_AUTHORIZATIONS(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      HsqlNameManager.HsqlName localHsqlName = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[26].name, false, 20);
      localTable.createPrimaryKeyConstraint(localHsqlName, new int[] { 0, 1, 2 }, false);
      return localTable;
    }
    if (paramSession.isAdmin()) {
  ...
  private void insertRoles(Session paramSession, Table paramTable, Grantee paramGrantee, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      localObject1 = this.database.getGranteeManager().getRoleNames();
      Iterator localIterator = ((Set)localObject1).iterator();
      while (localIterator.hasNext())
      {
        localObject2 = (String)localIterator.next();
        localObject3 = paramTable.getEmptyRowData();
        localObject3[0] = paramGrantee.getName().getNameString();
        localObject3[1] = localObject2;
        localObject3[2] = "YES";
        paramTable.insertSys(paramSession, localPersistentStore, (Object[])localObject3);
      }
    }
    else
    {
      localObject1 = paramGrantee.getDirectRoles();
      for (int i = 0; i < ((OrderedHashSet)localObject1).size(); i++)
      {
        localObject2 = (Grantee)((OrderedHashSet)localObject1).get(i);
        localObject3 = ((Grantee)localObject2).getName().getNameString();
        ...
        paramGrantee = this.database.getGranteeManager().getRole((String)localObject3);
  ...
  Table ASSERTIONS(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      HsqlNameManager.HsqlName localHsqlName = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[28].name, false, 20);
      localTable.createPrimaryKeyConstraint(localHsqlName, new int[] { 0, 1, 2 }, false);
      return localTable;
    }
    return localTable;
  ...
  Table AUTHORIZATIONS(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      localObject = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[29].name, false, 20);
      localTable.createPrimaryKeyConstraint((HsqlNameManager.HsqlName)localObject, new int[] { 0 }, true);
      return localTable;
    }
  ...
  {
    Table localTable = this.sysTables[31];
    if (localTable == null)
    {
      localTable = createBlankTable(sysTableHsqlNames[31]);
      addColumn(localTable, "CONSTRAINT_CATALOG", SQL_IDENTIFIER);
      addColumn(localTable, "CONSTRAINT_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable, "CONSTRAINT_NAME", SQL_IDENTIFIER);
  ...
  Table CHECK_CONSTRAINTS(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable1 == null)
    {
      ...
      HsqlNameManager.HsqlName localHsqlName = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[32].name, false, 20);
  ...
  Table COLLATIONS(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      HsqlNameManager.HsqlName localHsqlName = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[33].name, false, 20);
      localTable.createPrimaryKeyConstraint(localHsqlName, new int[] { 0, 1, 2 }, false);
      return localTable;
    }
  ...
  Table COLUMN_DOMAIN_USAGE(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable1 == null)
    {
      ...
      addColumn(localTable1, "TABLE_NAME", SQL_IDENTIFIER);
      addColumn(localTable1, "COLUMN_NAME", SQL_IDENTIFIER);
      HsqlNameManager.HsqlName localHsqlName1 = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[35].name, false, 20);
  ...
  Table COLUMN_UDT_USAGE(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable1 == null)
    {
      ...
      addColumn(localTable1, "TABLE_NAME", SQL_IDENTIFIER);
      addColumn(localTable1, "COLUMN_NAME", SQL_IDENTIFIER);
      HsqlNameManager.HsqlName localHsqlName1 = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[37].name, false, 20);
      localTable1.createPrimaryKeyConstraint(localHsqlName1, new int[] { 0, 1, 2, 3, 4, 5, 6 }, false);
      return localTable1;
    }
    Iterator localIterator = allTables();
  ...
  {
    Table localTable1 = this.sysTables[38];
    if (localTable1 == null)
    {
      localTable1 = createBlankTable(sysTableHsqlNames[38]);
      addColumn(localTable1, "TABLE_CATALOG", SQL_IDENTIFIER);
      addColumn(localTable1, "TABLE_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable1, "TABLE_NAME", SQL_IDENTIFIER);
      addColumn(localTable1, "COLUMN_NAME", SQL_IDENTIFIER);
      ...
      HsqlNameManager.HsqlName localHsqlName = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[38].name, false, 20);
        ...
        for (int j = 0; j < i; j++)
        {
          ...
          if (localOrderedHashSet.contains(localColumnSchema.getName()))
          {
            ...
            if (localType.isCharacterType())
            {
              ...
              arrayOfObject[17] = localType.getCharacterSet().getSchemaName().name;
              arrayOfObject[18] = localType.getCharacterSet().getName().name;
              arrayOfObject[19] = this.database.getCatalogName().name;
              arrayOfObject[20] = localType.getCollation().getSchemaName().name;
              arrayOfObject[21] = localType.getCollation().getName().name;
            }
            else if (localType.isNumberType())
            {
              ...
              if (localType.isExactNumberType()) {
                arrayOfObject[12] = (arrayOfObject[46] = ValuePool.getLong(localType.scale));
              }
  ...
  Table CONSTRAINT_COLUMN_USAGE(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable1 == null)
    {
      ...
      addColumn(localTable1, "CONSTRAINT_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable1, "CONSTRAINT_NAME", SQL_IDENTIFIER);
      HsqlNameManager.HsqlName localHsqlName1 = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[39].name, false, 20);
      localTable1.createPrimaryKeyConstraint(localHsqlName1, new int[] { 0, 1, 2, 3, 4, 5, 6 }, false);
      return localTable1;
    }
    Iterator localIterator1 = this.database.schemaManager.databaseObjectIterator(3);
  ...
  Table CONSTRAINT_TABLE_USAGE(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      addColumn(localTable, "CONSTRAINT_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable, "CONSTRAINT_NAME", SQL_IDENTIFIER);
      localObject = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[40].name, false, 20);
  ...
  {
    Table localTable = this.sysTables[41];
    if (localTable == null)
    {
      localTable = createBlankTable(sysTableHsqlNames[41]);
      addColumn(localTable, "OBJECT_CATALOG", SQL_IDENTIFIER);
      addColumn(localTable, "OBJECT_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable, "OBJECT_NAME", SQL_IDENTIFIER);
      addColumn(localTable, "OBJECT_TYPE", SQL_IDENTIFIER);
      addColumn(localTable, "DTD_IDENTIFIER", SQL_IDENTIFIER);
      localObject = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[41].name, false, 20);
  ...
  Table DOMAIN_CONSTRAINTS(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      addColumn(localTable, "IS_DEFERRABLE", YES_OR_NO);
      addColumn(localTable, "INITIALLY_DEFERRED", YES_OR_NO);
      HsqlNameManager.HsqlName localHsqlName = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[42].name, false, 20);
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localType.isDomainType()) && (paramSession.getGrantee().isFullyAccessibleByRole(localType.getName())))
      {
        ...
        {
          Object[] arrayOfObject = localTable.getEmptyRowData();
          arrayOfObject[0] = (arrayOfObject[3] = this.database.getCatalogName().name);
          arrayOfObject[1] = (arrayOfObject[4] = localType.getSchemaName().name);
  ...
  Table DOMAINS(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      HsqlNameManager.HsqlName localHsqlName = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[43].name, false, 20);
      localTable.createPrimaryKeyConstraint(localHsqlName, new int[] { 0, 1, 2, 4, 5, 6 }, false);
      return localTable;
    }
    Iterator localIterator = this.database.schemaManager.databaseObjectIterator(13);
    while (localIterator.hasNext())
    {
      ...
      if ((localType.isDomainType()) && (paramSession.getGrantee().isAccessible(localType)))
      {
        ...
        if (localType.isCharacterType())
        {
          ...
          arrayOfObject[7] = localType.getCharacterSet().getSchemaName().name;
          arrayOfObject[8] = localType.getCharacterSet().getName().name;
          arrayOfObject[9] = this.database.getCatalogName().name;
          arrayOfObject[10] = localType.getCollation().getSchemaName().name;
          arrayOfObject[11] = localType.getCollation().getName().name;
        }
        else if (localType.isNumberType())
        {
          ...
          if (localType.isExactNumberType()) {
            arrayOfObject[14] = (arrayOfObject[23] = ValuePool.getLong(localType.scale));
          }
  ...
  {
    Table localTable1 = this.sysTables[44];
    if (localTable1 == null)
    {
      localTable1 = createBlankTable(sysTableHsqlNames[44]);
        ...
        for (int j = 0; j < i; j++)
        {
          ...
          if (localOrderedHashSet.contains(localColumnSchema1.getName()))
          {
            ...
            if ((!localType1.isDistinctType()) && (!localType1.isDomainType()) && (localType1.isArrayType()))
            {
              ...
              addTypeInfo(arrayOfObject, localType1.collectionBaseType());
              try
              {
                localTable1.insertSys(paramSession, paramPersistentStore, arrayOfObject);
              }
  ...
  void addTypeInfo(Object[] paramArrayOfObject, Type paramType)
  {
    ...
    if (paramType.isCharacterType())
    {
      ...
      paramArrayOfObject[9] = paramType.getCharacterSet().getSchemaName().name;
      paramArrayOfObject[10] = paramType.getCharacterSet().getName().name;
      paramArrayOfObject[11] = this.database.getCatalogName().name;
      paramArrayOfObject[12] = paramType.getCollation().getSchemaName().name;
      paramArrayOfObject[13] = paramType.getCollation().getName().name;
    }
    else if (paramType.isNumberType())
    {
      ...
      if (paramType.isExactNumberType()) {
        paramArrayOfObject[16] = (paramArrayOfObject[30] = ValuePool.getLong(paramType.scale));
      }
  ...
  Table ENABLED_ROLES(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      addColumn(localTable, "ROLE_NAME", SQL_IDENTIFIER);
      localObject = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[45].name, false, 20);
      localTable.createPrimaryKeyConstraint((HsqlNameManager.HsqlName)localObject, new int[] { 0 }, true);
      return localTable;
    }
  ...
  {
    Table localTable = this.sysTables[47];
    if (localTable == null)
    {
      localTable = createBlankTable(sysTableHsqlNames[47]);
      ...
      HsqlNameManager.HsqlName localHsqlName = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[47].name, false, 20);
  ...
  {
    Table localTable = this.sysTables[48];
    if (localTable == null)
    {
      localTable = createBlankTable(sysTableHsqlNames[48]);
      addColumn(localTable, "JAR_CATALOG", SQL_IDENTIFIER);
      addColumn(localTable, "JAR_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable, "JAR_NAME", SQL_IDENTIFIER);
      addColumn(localTable, "JAR_PATH", CHARACTER_DATA);
      HsqlNameManager.HsqlName localHsqlName = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[48].name, false, 20);
  ...
  {
    Table localTable1 = this.sysTables[49];
    if (localTable1 == null)
    {
      localTable1 = createBlankTable(sysTableHsqlNames[49]);
      addColumn(localTable1, "CONSTRAINT_CATALOG", SQL_IDENTIFIER);
      addColumn(localTable1, "CONSTRAINT_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable1, "CONSTRAINT_NAME", SQL_IDENTIFIER);
      addColumn(localTable1, "TABLE_CATALOG", SQL_IDENTIFIER);
      ...
      localObject = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[49].name, false, 20);
  ...
  Table PARAMETERS(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      addColumn(localTable, "DECLARED_NUMERIC_PRECISION", CARDINAL_NUMBER);
      addColumn(localTable, "DECLARED_NUMERIC_SCALE", CARDINAL_NUMBER);
      HsqlNameManager.HsqlName localHsqlName = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[55].name, false, 20);
      localTable.createPrimaryKeyConstraint(localHsqlName, new int[] { 0, 1, 2, 3 }, false);
      return localTable;
    }
        ...
        for (int j = 0; j < arrayOfRoutine.length; j++)
        {
          ...
          for (int k = 0; k < i; k++)
          {
            ...
            if (localType.isCharacterType())
            {
              ...
              arrayOfObject[18] = localType.getCharacterSet().getSchemaName().name;
              arrayOfObject[19] = localType.getCharacterSet().getName().name;
              arrayOfObject[20] = this.database.getCatalogName().name;
              arrayOfObject[21] = localType.getCollation().getSchemaName().name;
              arrayOfObject[22] = localType.getCollation().getName().name;
            }
            else if (localType.isNumberType())
            {
  ...
  {
    Table localTable1 = this.sysTables[56];
    if (localTable1 == null)
    {
      localTable1 = createBlankTable(sysTableHsqlNames[56]);
      addColumn(localTable1, "CONSTRAINT_CATALOG", SQL_IDENTIFIER);
      addColumn(localTable1, "CONSTRAINT_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable1, "CONSTRAINT_NAME", SQL_IDENTIFIER);
      ...
      HsqlNameManager.HsqlName localHsqlName1 = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[56].name, false, 20);
  ...
  Table ROLE_COLUMN_GRANTS(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    Object localObject = this.database.sessionManager.newSysSession(SqlInvariants.INFORMATION_SCHEMA_HSQLNAME, paramSession.getUser());
    Result localResult = ((Session)localObject).executeDirectStatement("SELECT C.GRANTOR, C.GRANTEE, C.TABLE_CATALOG, C.TABLE_SCHEMA, C.TABLE_NAME, C.COLUMN_NAME, C.PRIVILEGE_TYPE, C.IS_GRANTABLE FROM INFORMATION_SCHEMA.COLUMN_PRIVILEGES C JOIN INFORMATION_SCHEMA.APPLICABLE_ROLES ON C.GRANTEE = ROLE_NAME;");
    localTable.insertSys(paramSession, paramPersistentStore, localResult);
    ((Session)localObject).close();
    return localTable;
  }
  ...
  Table ROLE_ROUTINE_GRANTS(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    Object localObject = this.database.sessionManager.newSysSession(SqlInvariants.INFORMATION_SCHEMA_HSQLNAME, paramSession.getUser());
    Result localResult = ((Session)localObject).executeDirectStatement("SELECT R.GRANTOR, R.GRANTEE, R.SPECIFIC_CATALOG, R.SPECIFIC_SCHEMA, R.SPECIFIC_NAME, R.ROUTINE_CATALOG, R.ROUTINE_SCHEMA, R.ROUTINE_NAME, R.PRIVILEGE_TYPE, R.IS_GRANTABLE FROM INFORMATION_SCHEMA.ROUTINE_PRIVILEGES R JOIN INFORMATION_SCHEMA.APPLICABLE_ROLES ON R.GRANTEE = ROLE_NAME;");
    localTable.insertSys(paramSession, paramPersistentStore, localResult);
    ((Session)localObject).close();
    return localTable;
  }
  ...
  Table ROLE_TABLE_GRANTS(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      localObject = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[61].name, false, 20);
      localTable.createPrimaryKeyConstraint((HsqlNameManager.HsqlName)localObject, new int[] { 3, 4, 5, 0, 1 }, false);
      return localTable;
    }
    Object localObject = this.database.sessionManager.newSysSession(SqlInvariants.INFORMATION_SCHEMA_HSQLNAME, paramSession.getUser());
    Result localResult = ((Session)localObject).executeDirectStatement("SELECT T.GRANTOR, T.GRANTEE, T.TABLE_CATALOG, T.TABLE_SCHEMA, T.TABLE_NAME, T.PRIVILEGE_TYPE, T.IS_GRANTABLE, 'NO' FROM INFORMATION_SCHEMA.TABLE_PRIVILEGES T JOIN INFORMATION_SCHEMA.APPLICABLE_ROLES ON T.GRANTEE = ROLE_NAME;");
    localTable.insertSys(paramSession, paramPersistentStore, localResult);
    ((Session)localObject).close();
    return localTable;
  }
  ...
  Table ROLE_UDT_GRANTS(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      addColumn(localTable, "PRIVILEGE_TYPE", CHARACTER_DATA);
      addColumn(localTable, "IS_GRANTABLE", YES_OR_NO);
      localObject = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[62].name, false, 20);
      localTable.createPrimaryKeyConstraint((HsqlNameManager.HsqlName)localObject, null, false);
      return localTable;
    }
    Object localObject = this.database.sessionManager.newSysSession(SqlInvariants.INFORMATION_SCHEMA_HSQLNAME, paramSession.getUser());
    Result localResult = ((Session)localObject).executeDirectStatement("SELECT U.GRANTOR, U.GRANTEE, U.UDT_CATALOG, U.UDT_SCHEMA, U.UDT_NAME, U.PRIVILEGE_TYPE, U.IS_GRANTABLE FROM INFORMATION_SCHEMA.UDT_PRIVILEGES U JOIN INFORMATION_SCHEMA.APPLICABLE_ROLES ON U.GRANTEE = ROLE_NAME;");
    localTable.insertSys(paramSession, paramPersistentStore, localResult);
    ((Session)localObject).close();
    return localTable;
  }
  ...
  Table ROLE_USAGE_GRANTS(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      addColumn(localTable, "PRIVILEGE_TYPE", CHARACTER_DATA);
      addColumn(localTable, "IS_GRANTABLE", YES_OR_NO);
      localObject = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[63].name, false, 20);
      localTable.createPrimaryKeyConstraint((HsqlNameManager.HsqlName)localObject, new int[] { 0, 1, 2, 3, 4, 5, 6, 7 }, false);
      return localTable;
    }
    Object localObject = this.database.sessionManager.newSysSession(SqlInvariants.INFORMATION_SCHEMA_HSQLNAME, paramSession.getUser());
    Result localResult = ((Session)localObject).executeDirectStatement("SELECT U.GRANTOR, U.GRANTEE, U.OBJECT_CATALOG, U.OBJECT_SCHEMA, U.OBJECT_NAME, U.OBJECT_TYPE, U.PRIVILEGE_TYPE, U.IS_GRANTABLE FROM INFORMATION_SCHEMA.USAGE_PRIVILEGES U JOIN INFORMATION_SCHEMA.APPLICABLE_ROLES A ON U.GRANTEE = A.ROLE_NAME;");
    localTable.insertSys(paramSession, paramPersistentStore, localResult);
    ((Session)localObject).close();
    return localTable;
  }
  ...
  Table ROUTINE_PRIVILEGES(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      addColumn(localTable, "PRIVILEGE_TYPE", CHARACTER_DATA);
      addColumn(localTable, "IS_GRANTABLE", YES_OR_NO);
      HsqlNameManager.HsqlName localHsqlName = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[66].name, false, 20);
    ...
    while (localIterator.hasNext())
    {
      ...
      for (int i = 0; i < localOrderedHashSet1.size(); i++)
      {
        ...
        {
          localOrderedHashSet2.addAll((OrderedHashSet)localObject);
  ...
  Table ROUTINE_JAR_USAGE(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      addColumn(localTable, "JAR_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable, "JAR_NAME", SQL_IDENTIFIER);
      HsqlNameManager.HsqlName localHsqlName = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[65].name, false, 20);
      localTable.createPrimaryKeyConstraint(localHsqlName, new int[] { 0, 1, 2, 3, 4, 5 }, false);
      return localTable;
    }
    if (!paramSession.isAdmin()) {
  ...
  Table ROUTINE_ROUTINE_USAGE(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      addColumn(localTable, "ROUTINE_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable, "ROUTINE_NAME", SQL_IDENTIFIER);
      HsqlNameManager.HsqlName localHsqlName1 = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[67].name, false, 20);
      localTable.createPrimaryKeyConstraint(localHsqlName1, new int[] { 0, 1, 2, 3, 4, 5 }, false);
      return localTable;
    }
    Iterator localIterator = this.database.schemaManager.databaseObjectIterator(24);
  ...
  Table ROUTINE_SEQUENCE_USAGE(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      HsqlNameManager.HsqlName localHsqlName1 = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[68].name, false, 20);
      localTable.createPrimaryKeyConstraint(localHsqlName1, new int[] { 0, 1, 2, 3, 4, 5 }, false);
      return localTable;
    }
    Iterator localIterator = this.database.schemaManager.databaseObjectIterator(24);
  ...
  Table ROUTINE_TABLE_USAGE(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      addColumn(localTable, "TABLE_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable, "TABLE_NAME", SQL_IDENTIFIER);
      HsqlNameManager.HsqlName localHsqlName1 = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[69].name, false, 20);
  ...
  Table ROUTINES(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      HsqlNameManager.HsqlName localHsqlName = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[70].name, false, 20);
      ...
      if (paramSession.getGrantee().isAccessible(localRoutine))
      {
        ...
        if (localType != null)
        {
          ...
          else if (localType.isNumberType())
          {
            ...
            if (localType.isExactNumberType()) {
              arrayOfObject[24] = (arrayOfObject[84] = ValuePool.getLong(localType.scale));
            }
  ...
  Table SCHEMATA(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      addColumn(localTable, "SQL_PATH", CHARACTER_DATA);
      localObject1 = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[71].name, false, 20);
    ...
    for (int i = 0; i < localObject1.length; i++)
    {
      ...
      if (localGrantee.hasSchemaUpdateOrGrantRights(((Schema)localObject2).getName().getNameString()))
      {
        Object[] arrayOfObject = localTable.getEmptyRowData();
        arrayOfObject[0] = this.database.getCatalogName().name;
        arrayOfObject[1] = ((Schema)localObject2).getName().getNameString();
        arrayOfObject[2] = ((Schema)localObject2).getOwner().getName().getNameString();
        arrayOfObject[3] = this.database.getCatalogName().name;
        arrayOfObject[4] = str1;
        arrayOfObject[5] = str2;
  ...
  {
    Table localTable = this.sysTables[76];
    if (localTable == null)
    {
      localTable = createBlankTable(sysTableHsqlNames[76]);
  ...
  {
    Table localTable = this.sysTables[77];
    if (localTable == null)
    {
      localTable = createBlankTable(sysTableHsqlNames[77]);
      ...
      addColumn(localTable, "COMMENTS", CHARACTER_DATA);
      localObject = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[77].name, false, 20);
      localTable.createPrimaryKeyConstraint((HsqlNameManager.HsqlName)localObject, new int[] { 0 }, false);
      return localTable;
    }
    Object localObject = this.database.sessionManager.newSysSession(SqlInvariants.INFORMATION_SCHEMA_HSQLNAME, paramSession.getUser());
  ...
  {
    Table localTable = this.sysTables[78];
    if (localTable == null)
    {
      localTable = createBlankTable(sysTableHsqlNames[78]);
      addColumn(localTable, "SIZING_ID", CARDINAL_NUMBER);
      addColumn(localTable, "SIZING_NAME", CHARACTER_DATA);
      ...
      addColumn(localTable, "COMMENTS", CHARACTER_DATA);
      HsqlNameManager.HsqlName localHsqlName = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[78].name, false, 20);
      localTable.createPrimaryKeyConstraint(localHsqlName, new int[] { 0 }, false);
      return localTable;
    }
    return localTable;
  }
  ...
  {
    Table localTable1 = this.sysTables[79];
    if (localTable1 == null)
    {
      localTable1 = createBlankTable(sysTableHsqlNames[79]);
      addColumn(localTable1, "CONSTRAINT_CATALOG", SQL_IDENTIFIER);
      addColumn(localTable1, "CONSTRAINT_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable1, "CONSTRAINT_NAME", SQL_IDENTIFIER);
      ...
      localObject = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[79].name, false, 20);
  ...
  Table TRANSLATIONS(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      HsqlNameManager.HsqlName localHsqlName = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[82].name, false, 20);
      localTable.createPrimaryKeyConstraint(localHsqlName, new int[] { 0, 1, 2 }, false);
      return localTable;
    }
    return localTable;
  ...
  Table TRIGGER_ROUTINE_USAGE(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      addColumn(localTable, "SPECIFIC_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable, "SPECIFIC_NAME", SQL_IDENTIFIER);
      HsqlNameManager.HsqlName localHsqlName1 = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[84].name, false, 20);
      localTable.createPrimaryKeyConstraint(localHsqlName1, new int[] { 0, 1, 2, 3, 4, 5 }, false);
      return localTable;
    }
    Iterator localIterator = this.database.schemaManager.databaseObjectIterator(8);
  ...
  Table TRIGGER_SEQUENCE_USAGE(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      addColumn(localTable, "SEQUENCE_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable, "SEQUENCE_NAME", SQL_IDENTIFIER);
      HsqlNameManager.HsqlName localHsqlName1 = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[85].name, false, 20);
      localTable.createPrimaryKeyConstraint(localHsqlName1, new int[] { 0, 1, 2, 3, 4, 5 }, false);
      return localTable;
    }
    Iterator localIterator = this.database.schemaManager.databaseObjectIterator(8);
  ...
  {
    Table localTable = this.sysTables[86];
    if (localTable == null)
    {
      localTable = createBlankTable(sysTableHsqlNames[86]);
      addColumn(localTable, "TRIGGER_CATALOG", SQL_IDENTIFIER);
      addColumn(localTable, "TRIGGER_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable, "TRIGGER_NAME", SQL_IDENTIFIER);
      addColumn(localTable, "TABLE_CATALOG", SQL_IDENTIFIER);
      addColumn(localTable, "TABLE_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable, "TABLE_NAME", SQL_IDENTIFIER);
      HsqlNameManager.HsqlName localHsqlName1 = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[86].name, false, 20);
      localTable.createPrimaryKeyConstraint(localHsqlName1, new int[] { 0, 1, 2, 3, 4, 5 }, false);
      return localTable;
    }
    Iterator localIterator = this.database.schemaManager.databaseObjectIterator(8);
  ...
  Table TRIGGERS(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      addColumn(localTable, "CREATED", TIME_STAMP);
      HsqlNameManager.HsqlName localHsqlName = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[88].name, false, 20);
      localTable.createPrimaryKeyConstraint(localHsqlName, new int[] { 0, 1, 2 }, false);
      return localTable;
    }
    Iterator localIterator = this.database.schemaManager.databaseObjectIterator(8);
  ...
  {
    Table localTable = this.sysTables[90];
    if (localTable == null)
    {
      localTable = createBlankTable(sysTableHsqlNames[90]);
      addColumn(localTable, "GRANTOR", SQL_IDENTIFIER);
      addColumn(localTable, "GRANTEE", SQL_IDENTIFIER);
      addColumn(localTable, "UDT_CATALOG", SQL_IDENTIFIER);
      addColumn(localTable, "UDT_SCHEMA", SQL_IDENTIFIER);
      ...
      addColumn(localTable, "PRIVILEGE_TYPE", CHARACTER_DATA);
      addColumn(localTable, "IS_GRANTABLE", YES_OR_NO);
      HsqlNameManager.HsqlName localHsqlName = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[90].name, false, 20);
      localTable.createPrimaryKeyConstraint(localHsqlName, new int[] { 0, 1, 2, 3, 4 }, false);
      return localTable;
    }
  ...
  {
    Table localTable = this.sysTables[91];
    Object localObject1;
    if (localTable == null)
    {
      localTable = createBlankTable(sysTableHsqlNames[91]);
      addColumn(localTable, "GRANTOR", SQL_IDENTIFIER);
      addColumn(localTable, "GRANTEE", SQL_IDENTIFIER);
      addColumn(localTable, "OBJECT_CATALOG", SQL_IDENTIFIER);
      addColumn(localTable, "OBJECT_SCHEMA", SQL_IDENTIFIER);
      ...
      addColumn(localTable, "PRIVILEGE_TYPE", CHARACTER_DATA);
      addColumn(localTable, "IS_GRANTABLE", YES_OR_NO);
      localObject1 = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[91].name, false, 20);
    ...
    while (localWrapperIterator.hasNext())
    {
      ...
      for (int i = 0; i < localOrderedHashSet1.size(); i++)
      {
        ...
        if (!localOrderedHashSet2.isEmpty())
        {
          localOrderedHashSet2.addAll((OrderedHashSet)localObject2);
  ...
  {
    Table localTable = this.sysTables[92];
    if (localTable == null)
    {
      localTable = createBlankTable(sysTableHsqlNames[92]);
      ...
      HsqlNameManager.HsqlName localHsqlName = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[92].name, false, 20);
      localTable.createPrimaryKeyConstraint(localHsqlName, new int[] { 0, 1, 2, 4, 5, 6 }, false);
      return localTable;
    }
    Iterator localIterator = this.database.schemaManager.databaseObjectIterator(12);
    while (localIterator.hasNext())
    {
      ...
      if (localType.isDistinctType())
      {
        ...
        if (localType.isCharacterType())
        {
          ...
          arrayOfObject[16] = localType.getCharacterSet().getSchemaName().name;
          arrayOfObject[17] = localType.getCharacterSet().getName().name;
          arrayOfObject[18] = this.database.getCatalogName().name;
          arrayOfObject[19] = localType.getCollation().getSchemaName().name;
          arrayOfObject[20] = localType.getCollation().getName().name;
        }
        else if (localType.isNumberType())
        {
          ...
          if (localType.isExactNumberType()) {
            arrayOfObject[23] = (arrayOfObject[31] = ValuePool.getLong(localType.scale));
          }
  ...
  {
    Table localTable1 = this.sysTables[94];
    if (localTable1 == null)
    {
      localTable1 = createBlankTable(sysTableHsqlNames[94]);
      addColumn(localTable1, "VIEW_CATALOG", SQL_IDENTIFIER);
      addColumn(localTable1, "VIEW_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable1, "VIEW_NAME", SQL_IDENTIFIER);
      ...
      localObject = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[94].name, false, 20);
  ...
  {
    Table localTable1 = this.sysTables[95];
    if (localTable1 == null)
    {
      localTable1 = createBlankTable(sysTableHsqlNames[95]);
      addColumn(localTable1, "VIEW_CATALOG", SQL_IDENTIFIER);
      addColumn(localTable1, "VIEW_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable1, "VIEW_NAME", SQL_IDENTIFIER);
      addColumn(localTable1, "TABLE_CATALOG", SQL_IDENTIFIER);
      addColumn(localTable1, "TABLE_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable1, "TABLE_NAME", SQL_IDENTIFIER);
      HsqlNameManager.HsqlName localHsqlName1 = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[95].name, false, 20);
  ...
  {
    Table localTable1 = this.sysTables[96];
    if (localTable1 == null)
    {
      localTable1 = createBlankTable(sysTableHsqlNames[96]);
      addColumn(localTable1, "TABLE_CATALOG", SQL_IDENTIFIER);
      addColumn(localTable1, "TABLE_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable1, "TABLE_NAME", SQL_IDENTIFIER);
      ...
      localObject = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[96].name, false, 20);
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\dbinfo\DatabaseInformationFull.class
