  ...
  extends DatabaseInformation
{
  ...
  protected final void init(Session paramSession)
  {
    ...
    localGranteeManager.grantSystemToPublic(Charset.SQL_CHARACTER, localRight);
    localGranteeManager.grantSystemToPublic(Charset.SQL_IDENTIFIER_CHARSET, localRight);
    localGranteeManager.grantSystemToPublic(Charset.SQL_TEXT, localRight);
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((!localTable2.isView()) && (isAccessibleTable(paramSession, localTable2)))
      {
        ...
        if (arrayOfInt != null)
        {
          ...
          Boolean localBoolean = localTable2.isBestRowIdentifiersStrict() ? Boolean.TRUE : Boolean.FALSE;
  ...
  final Table SYSTEM_COLUMNS(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable1 == null)
    {
      ...
      addColumn(localTable1, "SOURCE_DATA_TYPE", Type.SQL_SMALLINT);
    ...
    while (localIterator.hasNext())
    {
      ...
      if (isAccessibleTable(paramSession, localTable2))
      {
        ...
        for (int j = 0; j < i; j++)
        {
          ...
          if ((((Type)localObject2).isDistinctType()) || (((Type)localObject2).isDomainType()))
          {
            arrayOfObject[5] = ((Type)localObject2).getTypeDefinition();
            arrayOfObject[21] = arrayOfObject[4];
          }
  ...
  final Table SYSTEM_INDEXINFO(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable1 == null)
    {
      ...
      localTable1.createPrimaryKeyConstraint((HsqlNameManager.HsqlName)localObject1, new int[] { 0, 1, 2, 3, 4, 5, 7, 8 }, false);
      return localTable1;
    }
    Iterator localIterator = this.database.schemaManager.databaseObjectIterator(3);
    while (localIterator.hasNext())
  ...
  Table SYSTEM_PROCEDURES(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      Object[] arrayOfObject = localTable.getEmptyRowData();
      arrayOfObject[0] = (arrayOfObject[0] = this.database.getCatalogName().name);
      arrayOfObject[1] = localRoutine.getSchemaName().name;
      arrayOfObject[2] = localRoutine.getName().name;
  ...
  final Table SYSTEM_CONNECTION_PROPERTIES(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      localObject1 = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[18].name, false, 20);
  ...
  final Table SYSTEM_TYPEINFO(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localObject != null)
      {
        ...
        arrayOfObject[7] = ((((Type)localObject).isCharacterType()) && (((Type)localObject).getCollation().isCaseSensitive()) ? Boolean.TRUE : Boolean.FALSE);
  ...
  Table SYSTEM_USERS(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    for (int i = 0; i < ((HsqlArrayList)localObject).size(); i++)
    {
      ...
      arrayOfObject[1] = (localUser.isAdmin() ? Boolean.TRUE : Boolean.FALSE);
  ...
  final Table COLUMN_PRIVILEGES(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable1 == null)
    {
      ...
      localObject1 = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[36].name, false, 20);
  ...
  final Table SEQUENCES(Session paramSession, PersistentStore paramPersistentStore)
  {
    ...
    if (localTable == null)
    {
      ...
      HsqlNameManager.HsqlName localHsqlName = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[72].name, false, 20);
  ...
  {
    Table localTable1 = this.sysTables[80];
    Object localObject1;
    if (localTable1 == null)
    {
      localTable1 = createBlankTable(sysTableHsqlNames[80]);
      addColumn(localTable1, "GRANTOR", SQL_IDENTIFIER);
      addColumn(localTable1, "GRANTEE", SQL_IDENTIFIER);
      addColumn(localTable1, "TABLE_CATALOG", SQL_IDENTIFIER);
      addColumn(localTable1, "TABLE_SCHEMA", SQL_IDENTIFIER);
      ...
      localObject1 = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[80].name, false, 20);
  ...
  {
    Table localTable1 = this.sysTables[81];
    if (localTable1 == null)
    {
      localTable1 = createBlankTable(sysTableHsqlNames[81]);
      addColumn(localTable1, "TABLE_CATALOG", SQL_IDENTIFIER);
      addColumn(localTable1, "TABLE_SCHEMA", SQL_IDENTIFIER);
      addColumn(localTable1, "TABLE_NAME", SQL_IDENTIFIER);
      addColumn(localTable1, "TABLE_TYPE", CHARACTER_DATA);
      ...
      addColumn(localTable1, "COMMIT_ACTION", CHARACTER_DATA);
      localObject = HsqlNameManager.newInfoSchemaObjectName(sysTableHsqlNames[81].name, false, 20);
  ...
  {
    Table localTable = this.sysTables[46];
    if (localTable == null)
    {
      localTable = createBlankTable(sysTableHsqlNames[46]);
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\dbinfo\DatabaseInformationMain.class
