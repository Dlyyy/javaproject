...
public class Tokens
{
  ...
  static
  {
    ...
    reservedKeys.put("ARRAY_MAX_CARDINALITY", 10);
    reservedKeys.put("AS", 11);
    reservedKeys.put("ASENSITIVE", 12);
    reservedKeys.put("ASYMMETRIC", 13);
    reservedKeys.put("AT", 14);
    reservedKeys.put("ATOMIC", 15);
    reservedKeys.put("AUTHORIZATION", 16);
    reservedKeys.put("AVG", 17);
    reservedKeys.put("BEGIN", 18);
    reservedKeys.put("BEGIN_FRAME", 19);
    reservedKeys.put("BEGIN_PARTITION", 20);
    reservedKeys.put("BETWEEN", 21);
    reservedKeys.put("BIGINT", 22);
    reservedKeys.put("BINARY", 23);
    reservedKeys.put("BIT_LENGTH", 679);
    reservedKeys.put("BLOB", 24);
    reservedKeys.put("BOOLEAN", 25);
    reservedKeys.put("BOTH", 26);
    reservedKeys.put("BY", 27);
    reservedKeys.put("CALL", 28);
    reservedKeys.put("CALLED", 29);
    reservedKeys.put("CARDINALITY", 30);
    reservedKeys.put("CASCADED", 31);
    reservedKeys.put("CASE", 32);
    reservedKeys.put("CAST", 33);
    reservedKeys.put("CEIL", 34);
    reservedKeys.put("CEILING", 35);
    reservedKeys.put("CHAR", 36);
    reservedKeys.put("CHAR_LENGTH", 37);
    reservedKeys.put("CHARACTER", 38);
    reservedKeys.put("CHARACTER_LENGTH", 39);
    reservedKeys.put("CHECK", 40);
    reservedKeys.put("CLOB", 41);
    reservedKeys.put("CLOSE", 42);
    reservedKeys.put("COALESCE", 43);
    reservedKeys.put("COLLATE", 44);
    reservedKeys.put("COLLECT", 45);
    reservedKeys.put("COLUMN", 46);
    reservedKeys.put("COMMIT", 47);
    reservedKeys.put("COMPARABLE", 48);
    reservedKeys.put("CONDIITON", 49);
    reservedKeys.put("CONNECT", 50);
    reservedKeys.put("CONSTRAINT", 51);
    reservedKeys.put("CONTAINS", 52);
    reservedKeys.put("CONVERT", 53);
    reservedKeys.put("CORR", 54);
    reservedKeys.put("CORRESPONDING", 55);
    reservedKeys.put("COUNT", 56);
    reservedKeys.put("COVAR_POP", 57);
    reservedKeys.put("COVAR_SAMP", 58);
    reservedKeys.put("CREATE", 59);
    reservedKeys.put("CROSS", 60);
    reservedKeys.put("CUBE", 61);
    reservedKeys.put("CUME_DIST", 62);
    reservedKeys.put("CURRENT", 63);
    reservedKeys.put("CURRENT_CATALOG", 64);
    reservedKeys.put("CURRENT_DATE", 65);
    reservedKeys.put("CURRENT_DEFAULT_TRANSFORM_GROUP", 66);
    reservedKeys.put("CURRENT_PATH", 67);
    reservedKeys.put("CURRENT_ROLE", 68);
    reservedKeys.put("CURRENT_SCHEMA", 70);
    reservedKeys.put("CURRENT_TIME", 71);
    reservedKeys.put("CURRENT_TIMESTAMP", 72);
    reservedKeys.put("DO", 91);
    reservedKeys.put("CURRENT_TRANSFORM_GROUP_FOR_TYPE", 73);
    reservedKeys.put("CURRENT_USER", 74);
    reservedKeys.put("CURSOR", 75);
    reservedKeys.put("CYCLE", 76);
    reservedKeys.put("DATE", 77);
    reservedKeys.put("DAY", 78);
    reservedKeys.put("DEALLOCATE", 79);
    reservedKeys.put("DEC", 80);
    reservedKeys.put("DECIMAL", 81);
    reservedKeys.put("DECLARE", 82);
    reservedKeys.put("DEFAULT", 83);
    reservedKeys.put("DELETE", 84);
    reservedKeys.put("DENSE_RANK", 85);
    reservedKeys.put("DEREF", 86);
    reservedKeys.put("DESCRIBE", 87);
    reservedKeys.put("DETERMINISTIC", 88);
    reservedKeys.put("DISCONNECT", 89);
    reservedKeys.put("DISTINCT", 90);
    reservedKeys.put("DOUBLE", 92);
    reservedKeys.put("DROP", 93);
    reservedKeys.put("DYNAMIC", 94);
    reservedKeys.put("EACH", 95);
    reservedKeys.put("ELEMENT", 96);
    reservedKeys.put("ELSE", 97);
    reservedKeys.put("ELSEIF", 98);
    reservedKeys.put("END", 99);
    reservedKeys.put("END_FRAME", 101);
    reservedKeys.put("END_PARTITION", 102);
    reservedKeys.put("END_EXEC", 100);
    reservedKeys.put("EQUALS", 103);
    reservedKeys.put("ESCAPE", 104);
    reservedKeys.put("EVERY", 105);
    reservedKeys.put("EXCEPT", 106);
    reservedKeys.put("EXEC", 107);
    reservedKeys.put("EXECUTE", 108);
    reservedKeys.put("EXISTS", 109);
    reservedKeys.put("EXIT", 110);
    reservedKeys.put("EXP", 111);
    reservedKeys.put("EXTERNAL", 112);
    reservedKeys.put("EXTRACT", 113);
    reservedKeys.put("FALSE", 114);
    reservedKeys.put("FETCH", 115);
    reservedKeys.put("FILTER", 116);
    reservedKeys.put("FIRST_VALUE", 117);
    reservedKeys.put("FLOAT", 118);
    reservedKeys.put("FLOOR", 119);
    reservedKeys.put("FOR", 120);
    reservedKeys.put("FOREIGN", 121);
    reservedKeys.put("FRAME_ROW", 122);
    reservedKeys.put("FREE", 123);
    reservedKeys.put("FROM", 124);
    reservedKeys.put("FULL", 125);
    reservedKeys.put("FUNCTION", 126);
    reservedKeys.put("FUSION", 127);
    reservedKeys.put("GET", 128);
    reservedKeys.put("GLOBAL", 129);
    reservedKeys.put("GRANT", 130);
    reservedKeys.put("GROUP", 131);
    reservedKeys.put("GROUPING", 133);
    reservedKeys.put("HANDLER", 134);
    reservedKeys.put("HAVING", 135);
    reservedKeys.put("HOLD", 136);
    reservedKeys.put("HOUR", 137);
    reservedKeys.put("IDENTITY", 138);
    reservedKeys.put("IF", 434);
    reservedKeys.put("IMPORT", 139);
    reservedKeys.put("IN", 140);
    reservedKeys.put("INDICATOR", 141);
    reservedKeys.put("INNER", 142);
    reservedKeys.put("INOUT", 143);
    reservedKeys.put("INSENSITIVE", 144);
    reservedKeys.put("INSERT", 145);
    reservedKeys.put("INT", 146);
    reservedKeys.put("INTEGER", 147);
    reservedKeys.put("INTERSECT", 148);
    reservedKeys.put("INTERSECTION", 149);
    reservedKeys.put("INTERVAL", 150);
    reservedKeys.put("INTO", 151);
    reservedKeys.put("IS", 152);
    reservedKeys.put("ITERATE", 153);
    reservedKeys.put("JOIN", 154);
    reservedKeys.put("LAG", 155);
    reservedKeys.put("LANGUAGE", 156);
    reservedKeys.put("LARGE", 157);
    reservedKeys.put("LAST_VALUE", 158);
    reservedKeys.put("LATERAL", 159);
    reservedKeys.put("LEAD", 160);
    reservedKeys.put("LEADING", 161);
    reservedKeys.put("LEAVE", 162);
    reservedKeys.put("LEFT", 163);
    reservedKeys.put("LIKE", 164);
    reservedKeys.put("LIKE_REGX", 165);
    reservedKeys.put("LN", 166);
    reservedKeys.put("LOCAL", 167);
    reservedKeys.put("LOCALTIME", 168);
    reservedKeys.put("LOCALTIMESTAMP", 169);
    reservedKeys.put("LOOP", 170);
    reservedKeys.put("LOWER", 171);
    reservedKeys.put("MATCH", 172);
    reservedKeys.put("MAX", 173);
    reservedKeys.put("MAX_CARDINALITY", 174);
    reservedKeys.put("MEMBER", 175);
    reservedKeys.put("MERGE", 176);
    reservedKeys.put("METHOD", 177);
    reservedKeys.put("MIN", 178);
    reservedKeys.put("MINUTE", 179);
    reservedKeys.put("MOD", 180);
    reservedKeys.put("MODIFIES", 181);
    reservedKeys.put("MODULE", 182);
    reservedKeys.put("MONTH", 183);
    reservedKeys.put("MULTISET", 184);
    reservedKeys.put("NATIONAL", 185);
    reservedKeys.put("NATURAL", 186);
    reservedKeys.put("NCHAR", 187);
    reservedKeys.put("NCLOB", 188);
    reservedKeys.put("NEW", 189);
    reservedKeys.put("NO", 190);
    reservedKeys.put("NONE", 191);
    reservedKeys.put("NORMALIZE", 192);
    reservedKeys.put("NOT", 193);
    reservedKeys.put("NTH_VALUE", 194);
    reservedKeys.put("NTILE", 195);
    reservedKeys.put("NULL", 196);
    reservedKeys.put("NULLIF", 197);
    reservedKeys.put("NUMERIC", 198);
    reservedKeys.put("OCCURRENCES_REGEX", 199);
    reservedKeys.put("OCTET_LENGTH", 200);
    reservedKeys.put("OF", 201);
    reservedKeys.put("OFFSET", 202);
    reservedKeys.put("OLD", 203);
    reservedKeys.put("ON", 204);
    reservedKeys.put("ONLY", 205);
    reservedKeys.put("OPEN", 206);
    reservedKeys.put("OR", 207);
    reservedKeys.put("ORDER", 208);
    reservedKeys.put("OUT", 209);
    reservedKeys.put("OUTER", 210);
    reservedKeys.put("OVER", 211);
    reservedKeys.put("OVERLAPS", 212);
    reservedKeys.put("OVERLAY", 213);
    reservedKeys.put("PARAMETER", 214);
    reservedKeys.put("PARTITION", 215);
    reservedKeys.put("PERCENT_RANK", 217);
    reservedKeys.put("PERCENTILE_CONT", 218);
    reservedKeys.put("PERCENTILE_DISC", 219);
    reservedKeys.put("PERIOD", 220);
    reservedKeys.put("POSITION", 222);
    reservedKeys.put("POSITION_REGEX", 223);
    reservedKeys.put("POWER", 224);
    reservedKeys.put("PRECEDES", 225);
    reservedKeys.put("PRECISION", 226);
    reservedKeys.put("PREPARE", 227);
    reservedKeys.put("PRIMARY", 228);
    reservedKeys.put("PROCEDURE", 229);
    reservedKeys.put("RANGE", 230);
    reservedKeys.put("RANK", 231);
    reservedKeys.put("READS", 232);
    reservedKeys.put("REAL", 233);
    reservedKeys.put("RECURSIVE", 234);
    reservedKeys.put("REF", 235);
    reservedKeys.put("REFERENCES", 236);
    reservedKeys.put("REFERENCING", 237);
    reservedKeys.put("REGR_AVGX", 238);
    reservedKeys.put("REGR_AVGY", 239);
    reservedKeys.put("REGR_COUNT", 240);
    reservedKeys.put("REGR_INTERCEPT", 241);
    reservedKeys.put("REGR_R2", 242);
    reservedKeys.put("REGR_SLOPE", 243);
    reservedKeys.put("REGR_SXX", 244);
    reservedKeys.put("REGR_SXY", 245);
    reservedKeys.put("REGR_SYY", 246);
    reservedKeys.put("RELEASE", 247);
    reservedKeys.put("REPEAT", 248);
    reservedKeys.put("RESIGNAL", 249);
    reservedKeys.put("RETURN", 251);
    reservedKeys.put("RETURNS", 252);
    reservedKeys.put("REVOKE", 253);
    reservedKeys.put("RIGHT", 254);
    reservedKeys.put("ROLLBACK", 255);
    reservedKeys.put("ROLLUP", 256);
    reservedKeys.put("ROW", 257);
    reservedKeys.put("ROW_NUMBER", 258);
    reservedKeys.put("ROWS", 259);
    reservedKeys.put("SAVEPOINT", 260);
    reservedKeys.put("SCOPE", 261);
    reservedKeys.put("SCROLL", 262);
    reservedKeys.put("SEARCH", 263);
    reservedKeys.put("SECOND", 264);
    reservedKeys.put("SELECT", 265);
    reservedKeys.put("SENSITIVE", 266);
    reservedKeys.put("SESSION_USER", 267);
    reservedKeys.put("SET", 268);
    reservedKeys.put("SIGNAL", 269);
    reservedKeys.put("SIMILAR", 270);
    reservedKeys.put("SMALLINT", 271);
    reservedKeys.put("SOME", 272);
    reservedKeys.put("SPECIFIC", 273);
    reservedKeys.put("SPECIFICTYPE", 274);
    reservedKeys.put("SQL", 275);
    reservedKeys.put("SQLEXCEPTION", 276);
    reservedKeys.put("SQLSTATE", 277);
    reservedKeys.put("SQLWARNING", 278);
    reservedKeys.put("SQRT", 279);
    reservedKeys.put("STACKED", 280);
    reservedKeys.put("START", 281);
    reservedKeys.put("STATIC", 282);
    reservedKeys.put("STDDEV_POP", 283);
    reservedKeys.put("STDDEV_SAMP", 284);
    reservedKeys.put("SUBMULTISET", 285);
    reservedKeys.put("SUBSTRING", 286);
    reservedKeys.put("SUBSTRING_REGEX", 287);
    reservedKeys.put("SUCCEEDS", 288);
    reservedKeys.put("SUM", 289);
    reservedKeys.put("SYMMETRIC", 290);
    reservedKeys.put("SYSTEM", 291);
    reservedKeys.put("SYSTEM_TIME", 292);
    reservedKeys.put("SYSTEM_USER", 293);
    reservedKeys.put("TABLE", 294);
    reservedKeys.put("TABLESAMPLE", 295);
    reservedKeys.put("THEN", 296);
    reservedKeys.put("TIME", 297);
    reservedKeys.put("TIMESTAMP", 298);
    reservedKeys.put("TIMEZONE_HOUR", 299);
    reservedKeys.put("TIMEZONE_MINUTE", 300);
    reservedKeys.put("TO", 301);
    reservedKeys.put("TRAILING", 302);
    reservedKeys.put("TRANSLATE", 303);
    reservedKeys.put("TRANSLATE_REGEX", 304);
    reservedKeys.put("TRANSLATION", 305);
    reservedKeys.put("TREAT", 306);
    reservedKeys.put("TRIGGER", 307);
    reservedKeys.put("TRIM", 308);
    reservedKeys.put("TRIM_ARRAY", 309);
    reservedKeys.put("TRUE", 310);
    reservedKeys.put("TRUNCATE", 311);
    reservedKeys.put("UESCAPE", 312);
    reservedKeys.put("UNDO", 313);
    reservedKeys.put("UNION", 314);
    reservedKeys.put("UNIQUE", 315);
    reservedKeys.put("UNKNOWN", 316);
    reservedKeys.put("UNNEST", 317);
    reservedKeys.put("UNTIL", 318);
    reservedKeys.put("UPDATE", 319);
    reservedKeys.put("UPPER", 320);
    reservedKeys.put("USER", 321);
    reservedKeys.put("USING", 322);
    reservedKeys.put("VALUE", 323);
    reservedKeys.put("VALUES", 324);
    reservedKeys.put("VAR_POP", 325);
    reservedKeys.put("VAR_SAMP", 326);
    reservedKeys.put("VARBINARY", 327);
    reservedKeys.put("VARCHAR", 328);
    reservedKeys.put("VARYING", 329);
    reservedKeys.put("WHEN", 331);
    reservedKeys.put("WHENEVER", 332);
    reservedKeys.put("WHERE", 333);
    reservedKeys.put("WIDTH_BUCKET", 334);
    reservedKeys.put("WINDOW", 335);
    reservedKeys.put("WITH", 336);
    reservedKeys.put("WITHIN", 337);
    reservedKeys.put("WITHOUT", 338);
    reservedKeys.put("WHILE", 339);
    reservedKeys.put("YEAR", 340);
    commandSet = new IntValueHashMap(419);
    commandSet.put("ACTION", 353);
    commandSet.put("ADD", 355);
    commandSet.put("ADMIN", 356);
    commandSet.put("AFTER", 357);
    commandSet.put("AGGREGATE", 582);
    commandSet.put("ALIAS", 581);
    commandSet.put("ALWAYS", 358);
    commandSet.put("ASC", 359);
    commandSet.put("AUTHENTICATION", 584);
    commandSet.put("AUTOCOMMIT", 583);
    commandSet.put("BACKUP", 585);
    commandSet.put("BEFORE", 364);
    commandSet.put("BINARY_DOUBLE", 587);
    commandSet.put("BINARY_FLOAT", 586);
    commandSet.put("BIT", 588);
    commandSet.put("BYTE", 591);
    commandSet.put("BLOCKING", 589);
    commandSet.put("BODY", 590);
    commandSet.put("CACHE", 592);
    commandSet.put("CACHED", 593);
    commandSet.put("CASCADE", 368);
    commandSet.put("CATALOG", 369);
    commandSet.put("CHARACTERISTICS", 375);
    commandSet.put("CHARACTERS", 376);
    commandSet.put("CHECKPOINT", 595);
    commandSet.put("CITEXT", 596);
    commandSet.put("CRYPT_KEY", 691);
    commandSet.put("CLASS", 597);
    commandSet.put("CLUSTERED", 598);
    commandSet.put("COLLATE", 44);
    commandSet.put("COLLATION", 379);
    commandSet.put("COMMENT", 599);
    commandSet.put("COMMITTED", 386);
    commandSet.put("COMPACT", 600);
    commandSet.put("COMPRESSED", 601);
    commandSet.put("CONDIITON_IDENTIFIER", 387);
    commandSet.put("CONFLICT", 602);
    commandSet.put("CONSTRAINTS", 394);
    commandSet.put("CONTINUE", 397);
    commandSet.put("CONTROL", 603);
    commandSet.put("CURDATE", 692);
    commandSet.put("CURRVAL", 604);
    commandSet.put("CURTIME", 693);
    commandSet.put("DATA", 399);
    commandSet.put("DATABASE", 605);
    commandSet.put("DEADLOCK", 606);
    commandSet.put("DEFAULTS", 402);
    commandSet.put("DEFINER", 406);
    commandSet.put("DEFRAG", 607);
    commandSet.put("DELAY", 608);
    commandSet.put("DESC", 410);
    commandSet.put("DIAGNOSTICS", 412);
    commandSet.put("DIGEST", 609);
    commandSet.put("DOMAIN", 414);
    commandSet.put("EVENT", 610);
    commandSet.put("EXCEPTION", 418);
    commandSet.put("EXCLUDING", 420);
    commandSet.put("EXPLAIN", 611);
    commandSet.put("EXPRESSION", 421);
    commandSet.put("FEATURE", 612);
    commandSet.put("FILE", 613);
    commandSet.put("FILES", 614);
    commandSet.put("FINAL", 422);
    commandSet.put("FIRST", 423);
    commandSet.put("FORMAT", 615);
    commandSet.put("FOUND", 426);
    commandSet.put("G", 427);
    commandSet.put("GC", 616);
    commandSet.put("GENERATED", 429);
    commandSet.put("GRANTED", 432);
    commandSet.put("GROUP_CONCAT", 719);
    commandSet.put("HEADER", 617);
    commandSet.put("IF", 434);
    commandSet.put("IGNORE", 435);
    commandSet.put("IGNORECASE", 618);
    commandSet.put("IMMEDIATELY", 619);
    commandSet.put("INCLUDING", 438);
    commandSet.put("INCREMENT", 439);
    commandSet.put("INDEX", 621);
    commandSet.put("INDEXER", 622);
    commandSet.put("INITIAL", 623);
    commandSet.put("INPUT", 441);
    commandSet.put("INSTEAD", 444);
    commandSet.put("INTEGRITY", 620);
    commandSet.put("IS_AUTOCOMMIT", 722);
    commandSet.put("ISOLATION", 446);
    commandSet.put("IS_READONLY_DATABASE", 723);
    commandSet.put("IS_READONLY_DATABASE_FILES", 724);
    commandSet.put("IS_READONLY_SESSION", 725);
    commandSet.put("JAVA", 447);
    commandSet.put("K", 448);
    commandSet.put("KEY", 449);
    commandSet.put("LAST", 452);
    commandSet.put("LASTVAL", 624);
    commandSet.put("LENGTH", 453);
    commandSet.put("LEVEL", 454);
    commandSet.put("LIBRARY", 455);
    commandSet.put("LIMIT", 625);
    commandSet.put("LOB", 733);
    commandSet.put("LOCK", 629);
    commandSet.put("LOCKS", 630);
    commandSet.put("LONG", 631);
    commandSet.put("LONGBLOB", 806);
    commandSet.put("LONGTEXT", 807);
    commandSet.put("LONGVAR", 632);
    commandSet.put("M", 457);
    commandSet.put("MATCHED", 459);
    commandSet.put("MAXROWS", 633);
    commandSet.put("MAXVALUE", 460);
    commandSet.put("MEDIAN", 634);
    commandSet.put("MEDIUMBLOB", 808);
    commandSet.put("MEDIUMTEXT", 809);
    commandSet.put("MEMORY", 635);
    commandSet.put("MESSAGE_TEXT", 463);
    commandSet.put("MILLIS", 636);
    commandSet.put("MINUS", 637);
    commandSet.put("MINVALUE", 464);
    commandSet.put("MORE", 465);
    commandSet.put("MVCC", 742);
    commandSet.put("MVLOCKS", 743);
    commandSet.put("NAME", 467);
    commandSet.put("NEXT", 470);
    commandSet.put("NEXTVAL", 639);
    commandSet.put("NAN", 638);
    commandSet.put("NIO", 746);
    commandSet.put("NOW", 747);
    commandSet.put("NULLS", 473);
    commandSet.put("NUMBER", 474);
    commandSet.put("NVARCHAR2", 640);
    commandSet.put("NVL2", 641);
    commandSet.put("OBJECT", 475);
    commandSet.put("OCTETS", 476);
    commandSet.put("OFF", 642);
    commandSet.put("OPTION", 477);
    commandSet.put("ORDINALITY", 480);
    commandSet.put("OTHERS", 481);
    commandSet.put("OVERRIDING", 483);
    commandSet.put("P", 484);
    commandSet.put("PAD", 485);
    commandSet.put("PARTIAL", 492);
    commandSet.put("PASSWORD", 643);
    commandSet.put("PERFORM", 644);
    commandSet.put("PLACING", 495);
    commandSet.put("PLAN", 645);
    commandSet.put("PRESERVE", 498);
    commandSet.put("PREVVAL", 646);
    commandSet.put("PRIVILEGES", 500);
    commandSet.put("PROPERTY", 647);
    commandSet.put("RAW", 648);
    commandSet.put("READ", 502);
    commandSet.put("READONLY", 649);
    commandSet.put("REFERENTIAL", 650);
    commandSet.put("REGULAR", 651);
    commandSet.put("RENAME", 652);
    commandSet.put("REPEATABLE", 504);
    commandSet.put("RESET", 653);
    commandSet.put("RESTART", 506);
    commandSet.put("RESTRICT", 507);
    commandSet.put("RESULT", 250);
    commandSet.put("ROLE", 512);
    commandSet.put("ROUTINE", 513);
    commandSet.put("ROW_COUNT", 517);
    commandSet.put("ROWNUM", 654);
    commandSet.put("SCALE", 518);
    commandSet.put("SCHEMA", 519);
    commandSet.put("SCRIPT", 655);
    commandSet.put("SEQUENCE", 527);
    commandSet.put("SEPARATOR", 656);
    commandSet.put("SERIALIZABLE", 528);
    commandSet.put("SERVER", 531);
    commandSet.put("SESSION", 530);
    commandSet.put("SETS", 532);
    commandSet.put("SHUTDOWN", 657);
    commandSet.put("SIMPLE", 533);
    commandSet.put("SIZE", 534);
    commandSet.put("SOURCE", 535);
    commandSet.put("SQL_BIGINT", 851);
    commandSet.put("SQL_BINARY", 852);
    commandSet.put("SQL_BIT", 853);
    commandSet.put("SQL_BLOB", 854);
    commandSet.put("SQL_BOOLEAN", 855);
    commandSet.put("SQL_CHAR", 856);
    commandSet.put("SQL_CLOB", 857);
    commandSet.put("SQL_DATALINK", 860);
    commandSet.put("SQL_DATE", 858);
    commandSet.put("SQL_DECIMAL", 859);
    commandSet.put("SQL_DOUBLE", 861);
    commandSet.put("SQL_FLOAT", 862);
    commandSet.put("SQL_INTEGER", 863);
    commandSet.put("SQL_LONGNVARCHAR", 865);
    commandSet.put("SQL_LONGVARBINARY", 864);
    commandSet.put("SQL_LONGVARCHAR", 866);
    commandSet.put("SQL_NCHAR", 867);
    commandSet.put("SQL_NCLOB", 868);
    commandSet.put("SQL_NUMERIC", 869);
    commandSet.put("SQL_NVARCHAR", 870);
    commandSet.put("SQL_REAL", 871);
    commandSet.put("SQL_ROWID", 872);
    commandSet.put("SQL_SMALLINT", 874);
    commandSet.put("SQL_SQLXML", 873);
    commandSet.put("SQL_TIME", 875);
    commandSet.put("SQL_TIMESTAMP", 876);
    commandSet.put("SQL_TINYINT", 877);
    commandSet.put("SQL_VARBINARY", 878);
    commandSet.put("SQL_VARCHAR", 879);
    commandSet.put("SQL_TSI_DAY", 886);
    commandSet.put("SQL_TSI_FRAC_SECOND", 881);
    commandSet.put("SQL_TSI_MILLI_SECOND", 882);
    commandSet.put("SQL_TSI_HOUR", 885);
    commandSet.put("SQL_TSI_MINUTE", 884);
    commandSet.put("SQL_TSI_MONTH", 888);
    commandSet.put("SQL_TSI_QUARTER", 889);
    commandSet.put("SQL_TSI_SECOND", 883);
    commandSet.put("SQL_TSI_WEEK", 887);
    commandSet.put("SQL_TSI_YEAR", 890);
    commandSet.put("STATEMENT", 539);
    commandSet.put("STYLE", 541);
    commandSet.put("SYNONYM", 658);
    commandSet.put("SYNTAX", 659);
    commandSet.put("T", 543);
    commandSet.put("TDC", 660);
    commandSet.put("TEMP", 661);
    commandSet.put("TEMPORARY", 545);
    commandSet.put("TEXT", 662);
    commandSet.put("TYPES", 665);
    commandSet.put("TIMESTAMP_WITH_ZONE", 783);
    commandSet.put("TIMESTAMPADD", 784);
    commandSet.put("TIMESTAMPDIFF", 785);
    commandSet.put("TINYBLOB", 810);
    commandSet.put("TINYTEXT", 811);
    commandSet.put("TOP", 663);
    commandSet.put("TRANSACTION", 548);
    commandSet.put("TRANSACTION_ACTIVE", 549);
    commandSet.put("TRANSACTIONS_COMMITTED", 550);
    commandSet.put("TRANSACTIONS_ROLLED_BACK", 551);
    commandSet.put("TTI", 664);
    commandSet.put("TYPE", 557);
    commandSet.put("UNCOMMITTED", 559);
    commandSet.put("USAGE", 562);
    commandSet.put("USE", 666);
    commandSet.put("VIEW", 567);
    commandSet.put("VARCHAR2", 667);
    commandSet.put("WORK", 568);
    commandSet.put("WRAPPER", 570);
    commandSet.put("WRITE", 569);
    commandSet.put("WRITE_DELAY", 668);
    commandSet.put("ZONE", 571);
    commandSet.put("ACOS", 671);
    commandSet.put("ACTION_ID", 672);
    commandSet.put("ADD_MONTHS", 675);
    commandSet.put("ARRAY_SORT", 673);
    commandSet.put("ASCII", 674);
    commandSet.put("ASIN", 676);
    commandSet.put("ATAN", 677);
    commandSet.put("ATAN2", 678);
    commandSet.put("BITAND", 680);
    commandSet.put("BITANDNOT", 681);
    commandSet.put("BITLENGTH", 682);
    commandSet.put("BITNOT", 683);
    commandSet.put("BITOR", 684);
    commandSet.put("BITXOR", 685);
    commandSet.put("CASEWHEN", 594);
    commandSet.put("CONCAT", 687);
    commandSet.put("CONCAT_WS", 688);
    commandSet.put("CHR", 686);
    commandSet.put("COS", 689);
    commandSet.put("COT", 690);
    commandSet.put("DATABASE_NAME", 695);
    commandSet.put("DATE_ADD", 698);
    commandSet.put("DATE_SUB", 699);
    commandSet.put("DATEADD", 700);
    commandSet.put("DATEDIFF", 701);
    commandSet.put("DAY_NAME", 702);
    commandSet.put("DAY_OF_MONTH", 703);
    commandSet.put("DAY_OF_WEEK", 704);
    commandSet.put("DAY_OF_YEAR", 705);
    commandSet.put("DAYNAME", 706);
    commandSet.put("DAYOFMONTH", 707);
    commandSet.put("DAYOFWEEK", 708);
    commandSet.put("DAYOFYEAR", 709);
    commandSet.put("DAYS", 710);
    commandSet.put("DBTIMEZONE", 711);
    commandSet.put("DECODE", 712);
    commandSet.put("DEGREES", 713);
    commandSet.put("DIFFERENCE", 714);
    commandSet.put("DMOD", 715);
    commandSet.put("DUPLICATE", 812);
    commandSet.put("FROM_TZ", 716);
    commandSet.put("GREATEST", 718);
    commandSet.put("HEXTORAW", 717);
    commandSet.put("INSTR", 721);
    commandSet.put("IFNULL", 720);
    commandSet.put("ISNULL", 727);
    commandSet.put("LAST_DAY", 728);
    commandSet.put("LCASE", 729);
    commandSet.put("LEAST", 730);
    commandSet.put("LITERAL", 626);
    commandSet.put("LIVE", 627);
    commandSet.put("LOAD", 628);
    commandSet.put("LOAD_FILE", 731);
    commandSet.put("LOCATE", 732);
    commandSet.put("LOG", 734);
    commandSet.put("LOG10", 735);
    commandSet.put("LPAD", 736);
    commandSet.put("LTRIM", 737);
    commandSet.put("MONTH_NAME", 739);
    commandSet.put("MONTHNAME", 740);
    commandSet.put("MONTHS_BETWEEN", 741);
    commandSet.put("NAMES", 468);
    commandSet.put("NEW_TIME", 744);
    commandSet.put("NEXT_DAY", 745);
    commandSet.put("NUMTODSINTERVAL", 748);
    commandSet.put("NUMTOYMINTERVAL", 749);
    commandSet.put("NVL", 720);
    commandSet.put("OCTETLENGTH", 750);
    commandSet.put("PI", 751);
    commandSet.put("POSITION_ARRAY", 752);
    commandSet.put("QUARTER", 753);
    commandSet.put("RADIANS", 754);
    commandSet.put("RAND", 755);
    commandSet.put("RAWTOHEX", 756);
    commandSet.put("REGEXP_MATCHES", 757);
    commandSet.put("REGEXP_REPLACE", 758);
    commandSet.put("REGEXP_SUBSTRING", 759);
    commandSet.put("REGEXP_SUBSTRING_ARRAY", 760);
    commandSet.put("REPLACE", 761);
    commandSet.put("REVERSE", 762);
    commandSet.put("ROUND", 763);
    commandSet.put("ROUNDMAGIC", 764);
    commandSet.put("RPAD", 766);
    commandSet.put("RTRIM", 765);
    commandSet.put("SECONDS_SINCE_MIDNIGHT", 767);
    commandSet.put("SESSION_ID", 769);
    commandSet.put("SESSIONTIMEZONE", 772);
    commandSet.put("SIGN", 773);
    commandSet.put("SIN", 774);
    commandSet.put("SORT_ARRAY", 775);
    commandSet.put("SOUNDEX", 776);
    commandSet.put("SPACE", 536);
    commandSet.put("SUBSTR", 778);
    commandSet.put("SYS_EXTRACT_UTC", 779);
    commandSet.put("SYSDATE", 780);
    commandSet.put("SYSTIMESTAMP", 781);
    commandSet.put("TAN", 782);
    commandSet.put("TO_CHAR", 787);
    commandSet.put("TO_DATE", 788);
    commandSet.put("TO_DSINTERVAL", 789);
    commandSet.put("TO_YMINTERVAL", 790);
    commandSet.put("TO_NUMBER", 791);
    commandSet.put("TO_TIMESTAMP", 792);
    commandSet.put("TO_TIMESTAMP_TZ", 793);
    commandSet.put("TODAY", 794);
    commandSet.put("TRUNC", 798);
    commandSet.put("UCASE", 800);
    commandSet.put("TRANSACTION_ID", 796);
    commandSet.put("TRANSACTION_SIZE", 797);
    commandSet.put("TZ_OFFSET", 799);
    commandSet.put("UUID", 803);
    commandSet.put("UNIX_MILLIS", 801);
    commandSet.put("UNIX_TIMESTAMP", 802);
    commandSet.put("WEEK", 804);
    commandSet.put("WEEK_OF_YEAR", 805);
    commandSet.put("ISOLATION_LEVEL", 726);
    commandSet.put("SESSION_ISOLATION_LEVEL", 770);
    commandSet.put("DATABASE_ISOLATION_LEVEL", 694);
    commandSet.put("TRANSACTION_CONTROL", 795);
    commandSet.put("TIMEZONE", 786);
    commandSet.put("SESSION_TIMEZONE", 771);
    commandSet.put("DATABASE_TIMEZONE", 696);
    commandSet.put("DATABASE_VERSION", 697);
    commandSet.put("LOB_ID", 738);
    commandSet.put("SEQUENCE_ARRAY", 768);
    commandSet.put("*", 821);
    commandSet.put(")", 822);
    commandSet.put(":", 823);
    commandSet.put(",", 824);
    ...
    short[] arrayOfShort = { 11, 5, 2, 6, 14, 17, 27, 21, 26, 28, 32, 33, 55, 53, 56, 43, 59, 60, 83, 90, 91, 93, 97, 105, 109, 106, 120, 124, 125, 130, 131, 135, 151, 152, 140, 148, 154, 142, 163, 161, 164, 173, 178, 186, 197, 193, 204, 208, 207, 210, 228, 236, 254, 265, 268, 272, 283, 284, 289, 294, 296, 301, 302, 307, 314, 315, 322, 324, 325, 326, 331, 333, 336 };
    for (int i = 0; i < arrayOfShort.length; i++) {
      coreReservedWords.add(arrayOfShort[i]);
    }
    SQL_INTERVAL_FIELD_CODES = new short[] { 340, 183, 78, 137, 179, 264 };
    SQL_INTERVAL_FIELD_NAMES = new String[] { "YEAR", "MONTH", "DAY", "HOUR", "MINUTE", "SECOND" };
    sqlTSILookup = new IntKeyHashMap(10);
    sqlTSILookup.put(886, "SQL_TSI_DAY");
    sqlTSILookup.put(881, "SQL_TSI_FRAC_SECOND");
    sqlTSILookup.put(882, "SQL_TSI_MILLI_SECOND");
    sqlTSILookup.put(885, "SQL_TSI_HOUR");
    sqlTSILookup.put(884, "SQL_TSI_MINUTE");
    sqlTSILookup.put(888, "SQL_TSI_MONTH");
    sqlTSILookup.put(889, "SQL_TSI_QUARTER");
    sqlTSILookup.put(883, "SQL_TSI_SECOND");
    sqlTSILookup.put(887, "SQL_TSI_WEEK");
    sqlTSILookup.put(890, "SQL_TSI_YEAR");
  }
}


/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\Tokens.class
