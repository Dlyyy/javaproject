  ...
  extends Expression
{
  ...
  static final short[] emptyParamList = { 836, 822 };
  static final short[] optionalNoParamList = { 902, 2, 836, 822 };
  static final short[] optionalSingleParamList = { 836, 902, 1, 838, 822 };
  static final short[] singleParamList = { 836, 838, 822 };
  static final short[] optionalIntegerParamList = { 902, 3, 836, 904, 822 };
  static final short[] optionalDoubleParamList = { 836, 838, 902, 2, 824, 838, 822 };
  static final short[] doubleParamList = { 836, 838, 824, 838, 822 };
  static final short[] tripleParamList = { 836, 838, 824, 838, 824, 838, 822 };
  static final short[] quadParamList = { 836, 838, 824, 838, 824, 838, 824, 838, 822 };
  ...
  protected FunctionSQL(int paramInt)
  {
    ...
    case 2: 
      this.name = "POSITION";
      this.parseList = new short[] { 836, 838, 140, 838, 902, 5, 322, 901, 2, 376, 476, 822 };
      break;
    case 3: 
    case 4: 
      break;
    case 5: 
      this.name = "EXTRACT";
      this.parseList = new short[] { 836, 901, 17, 340, 183, 78, 137, 179, 264, 704, 805, 753, 705, 703, 805, 702, 739, 767, 299, 300, 124, 838, 822 };
      break;
    case 7: 
      this.name = "CHAR_LENGTH";
      this.parseList = new short[] { 836, 838, 902, 5, 322, 901, 2, 376, 476, 822 };
      break;
    case 6: 
    ...
    case 40: 
      this.name = "SUBSTRING";
      this.parseList = new short[] { 836, 838, 124, 838, 902, 2, 120, 838, 902, 5, 322, 901, 2, 376, 476, 822 };
      this.parseListAlt = new short[] { 836, 838, 824, 838, 902, 2, 824, 838, 822 };
      break;
    case 26: 
      this.name = "LOWER";
      this.parseList = singleParamList;
    ...
    case 41: 
      this.name = "TRIM";
      this.parseList = new short[] { 836, 902, 11, 902, 5, 901, 3, 161, 302, 26, 902, 1, 838, 124, 838, 822 };
      break;
    case 32: 
    case 42: 
      this.name = "OVERLAY";
      this.parseList = new short[] { 836, 838, 495, 838, 124, 838, 902, 2, 120, 838, 902, 2, 322, 376, 822 };
      break;
    case 53: 
  ...
  Object getValue(Session paramSession, Object[] paramArrayOfObject)
  {
    ...
    case 1: 
      ...
      if ((this.nodes[2] != null) && (((Number)this.nodes[2].valueData).intValue() == 476)) {
        l6 *= 2L;
      }
    ...
    case 13: 
      ...
      paramArrayOfObject[0] = this.nodeDataTypes[0].convertToType(paramSession, paramArrayOfObject[0], this.nodes[0].dataType);
      paramArrayOfObject[1] = this.nodeDataTypes[1].convertToType(paramSession, paramArrayOfObject[1], this.nodes[1].dataType);
      localObject1 = ((NumberType)this.nodeDataTypes[0]).modulo(paramSession, paramArrayOfObject[0], paramArrayOfObject[1], this.nodeDataTypes[1]);
      return localObject1;
    case 14: 
      if (paramArrayOfObject[0] == null) {
        return null;
    ...
    case 22: 
      for (int k = 0; k < paramArrayOfObject.length; k++)
      {
        ...
        paramArrayOfObject[k] = this.nodeDataTypes[k].convertToType(paramSession, paramArrayOfObject[k], this.nodes[k].dataType);
      }
      if (((NumberType)this.nodeDataTypes[3]).isNegative(paramArrayOfObject[3])) {
        throw Error.error(3446);
      }
      k = this.nodeDataTypes[1].compare(paramSession, paramArrayOfObject[1], paramArrayOfObject[2]);
      Type localType;
      if (this.nodeDataTypes[0].isNumberType()) {
        localType = this.nodeDataTypes[0];
      } else {
        localType = this.nodeDataTypes[0].getCombinedType(paramSession, this.nodeDataTypes[0], 33);
      }
      Object localObject7;
      switch (k)
      {
      case 0: 
        throw Error.error(3446);
      case -1: 
        if (this.nodeDataTypes[0].compare(paramSession, paramArrayOfObject[0], paramArrayOfObject[1]) < 0) {
          return ValuePool.INTEGER_0;
        }
        if (this.nodeDataTypes[0].compare(paramSession, paramArrayOfObject[0], paramArrayOfObject[2]) >= 0) {
          return this.dataType.add(paramSession, paramArrayOfObject[3], ValuePool.INTEGER_1, Type.SQL_INTEGER);
        }
        localObject6 = localType.subtract(paramSession, paramArrayOfObject[0], paramArrayOfObject[1], this.nodeDataTypes[1]);
        localObject7 = localType.subtract(paramSession, paramArrayOfObject[2], paramArrayOfObject[1], this.nodeDataTypes[1]);
        break;
      case 1: 
        if (this.nodeDataTypes[0].compare(paramSession, paramArrayOfObject[0], paramArrayOfObject[1]) > 0) {
          return ValuePool.INTEGER_0;
        ...
        localObject6 = localType.subtract(paramSession, paramArrayOfObject[1], paramArrayOfObject[0], this.nodeDataTypes[0]);
        localObject7 = localType.subtract(paramSession, paramArrayOfObject[1], paramArrayOfObject[2], this.nodeDataTypes[2]);
        break;
      default: 
      ...
      return this.dataType.add(paramSession, localObject6, ValuePool.INTEGER_1, Type.SQL_INTEGER);
    case 23: 
      if ((paramArrayOfObject[0] == null) || (paramArrayOfObject[1] == null)) {
        return null;
      }
      ...
      return ((CharacterType)this.dataType).substring(paramSession, paramArrayOfObject[0], l3, l7, ((this.nodes.length <= 3) || (this.nodes[3] == null) || (((Number)this.nodes[2].valueData).intValue() != 476)) || (this.nodes[2] != null), false);
    case 26: 
      if (paramArrayOfObject[0] == null) {
        return null;
      }
    ...
    case 31: 
      ...
      char c = ((String)localObject6).charAt(0);
      return ((CharacterType)this.dataType).trim(paramSession, paramArrayOfObject[2], c, bool1, bool3);
    case 32: 
  ...
  {
    if ((paramExpression instanceof FunctionSQL))
    {
      FunctionSQL localFunctionSQL = (FunctionSQL)paramExpression;
      return (super.equals(paramExpression)) && (this.funcType == localFunctionSQL.funcType);
    }
    return false;
  }
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\FunctionSQL.class
