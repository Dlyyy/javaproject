  ...
  extends ClientConnection
{
  ...
  public ClientConnectionHTTP(ClientConnectionHTTP paramClientConnectionHTTP)
  {
    super(paramClientConnectionHTTP);
  }
  ...
  {
    ClientConnectionHTTP localClientConnectionHTTP = new ClientConnectionHTTP(this);
    paramResult.setSessionRandomID(this.randomID);
    return localClientConnectionHTTP.execute(paramResult);
  }
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\ClientConnectionHTTP.class
