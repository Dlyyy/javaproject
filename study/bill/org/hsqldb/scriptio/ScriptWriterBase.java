  ...
  implements Runnable
{
  ...
  ScriptWriterBase(Database paramDatabase, String paramString, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    this.database = paramDatabase;
    this.isUserScript = paramBoolean3;
  ...
  public void setIncludeTableInit(boolean paramBoolean)
  {
    this.includeTableInit = paramBoolean;
  }
  ...
  protected void openFile()
  {
    try
    {
      FileAccess localFileAccess = this.isUserScript ? FileUtil.getFileUtil() : this.database.logger.getFileAccess();
  ...
  public void writeDDL()
    throws IOException
  {
    Result localResult = this.database.getScript(this.includeIndexRoots);
    writeSingleColumnResult(localResult);
  }
  
  public void writeExistingData()
    throws IOException
  {
    ...
    for (int i = 0; i < arrayOfString.length; i++)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        case 5: 
          ...
          break;
        case 7: 
          bool = (this.includeCachedData) && (!localTable.isDataReadOnly());
        }
        try
        {
          if (bool)
  ...
  public void writeTableInit(Table paramTable)
    throws IOException
  {}
  
  public void writeTableTerm(Table paramTable)
    throws IOException
  {}
  ...
  public abstract void writeRow(Session paramSession, Row paramRow, Table paramTable)
    throws IOException;
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\scriptio\ScriptWriterBase.class
