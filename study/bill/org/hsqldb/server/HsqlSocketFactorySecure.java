  ...
  implements HandshakeCompletedListener
{
    ...
    throws Exception
  {
    ...
    SSLSocket localSSLSocket = (SSLSocket)getSocketFactoryImpl().createSocket(paramSocket, paramString, paramInt, true);
    localSSLSocket.addHandshakeCompletedListener(this);
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\server\HsqlSocketFactorySecure.class
