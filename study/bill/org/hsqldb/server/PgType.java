...
public class PgType
{
  ...
  {
    this(paramType, paramInt1, Integer.valueOf(paramInt2), null);
  }
  
  protected PgType(Type paramType, int paramInt, Integer paramInteger, long paramLong)
    throws RecoverableOdbcFailure
  {
    this(paramType, paramInt, paramInteger, Integer.valueOf((int)paramLong));
    if (paramLong < 0L) {
    ...
    throws RecoverableOdbcFailure
  {
    ...
    case 92: 
      return new PgType(paramType, 1083, Integer.valueOf(8), paramType.precision);
    case 94: 
      return new PgType(paramType, 1266, Integer.valueOf(12), paramType.precision);
    case 93: 
      return new PgType(paramType, 1114, Integer.valueOf(8), paramType.precision);
    case 95: 
      return new PgType(paramType, 1296, Integer.valueOf(8), paramType.precision);
    case 101: 
    case 102: 
    case 107: 
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\server\PgType.class
