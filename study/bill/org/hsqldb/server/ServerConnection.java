  ...
  implements Runnable
{
  ...
  private void init()
  {
    ...
    try
    {
      ...
      case 1: 
        if (i != -2030400)
        {
          ...
          throw Error.error(null, 403, 0, new String[] { str, "2.3.4" });
        }
        int j = this.dataInput.readByte();
        receiveResult(j);
        break;
      case 2: 
        odbcConnect(i);
    ...
    {
      StringBuffer localStringBuffer = new StringBuffer(this.mThread + ":Failed to connect client.");
      if (this.user != null) {
        localStringBuffer.append("  User '" + this.user + "'.");
      }
      this.server.printWithThread(localStringBuffer.toString() + "  Stack trace follows.");
    ...
    throws ServerConnection.CleanExit, IOException
  {
    ...
    case 31: 
      ...
      break;
    case 5: 
      localResult2 = cancelStatement(localResult1);
      i = 1;
      break;
    case 32: 
    ...
    throws IOException, ServerConnection.CleanExit
  {
    ...
    try
    {
      ...
      case 'E': 
        ...
        localStatementPortal.bindResult.setPreparedExecuteProperties(localStatementPortal.parameters, i9, 0, 0, 0);
      ...
      {
        this.server.printWithThread("Interposing AFTER primary statement: " + (String)localObject1);
        odbcExecDirect((String)localObject1);
      }
      if (i != 0)
      {
        this.outPacket.reset();
  ...
  private Result cancelStatement(Result paramResult)
  {
    try
    {
      this.dbID = paramResult.getDatabaseId();
      long l = paramResult.getSessionId();
      ...
      return this.session.cancel(paramResult);
    }
    catch (HsqlException localHsqlException)
    {
      this.session = null;
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\server\ServerConnection.class
