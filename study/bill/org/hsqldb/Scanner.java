...
public class Scanner
{
  ...
  public Scanner(Session paramSession, String paramString)
  {
    reset(paramSession, paramString);
  }
  
  public void reset(Session paramSession, String paramString)
  {
    reset(paramString);
    if (paramSession != null)
    {
      this.backtickQuoting = paramSession.database.sqlSyntaxMys;
      this.charLiteral = paramSession.database.sqlCharLiteral;
    }
  }
  ...
  boolean shiftPrefixes()
  {
    ...
    this.token.isDelimitedPrefix = (this.token.tokenType == 913);
    return true;
  }
  ...
  void scanNumber()
  {
    ...
    while (this.currentPosition < this.limit)
    {
      ...
      case 116: 
        ...
        this.token.lobMultiplierType = Tokens.getNonKeywordID(str, 920);
        if (this.token.lobMultiplierType == 920)
        {
          this.token.tokenType = 920;
          this.token.isMalformed = true;
          return;
  ...
  public void scanStringPart(char paramChar)
  {
    ...
    for (this.currentPosition += 1;; this.currentPosition = (i + 1))
    {
      ...
      if (i < 0)
      {
        ...
        this.token.tokenType = (paramChar == '\'' ? 919 : 925);
        this.token.isMalformed = true;
        return;
      }
  ...
  void scanToken()
  {
    ...
    case 91: 
      this.token.tokenString = "[";
      this.token.tokenType = 831;
      this.currentPosition += 1;
      this.token.isDelimiter = true;
      return;
    case 93: 
      this.token.tokenString = "]";
      this.token.tokenType = 840;
      this.currentPosition += 1;
      this.token.isDelimiter = true;
      return;
    case 40: 
      this.token.tokenString = "(";
      this.token.tokenType = 836;
      this.currentPosition += 1;
      this.token.isDelimiter = true;
      return;
    case 41: 
      this.token.tokenString = ")";
      this.token.tokenType = 822;
      this.currentPosition += 1;
      this.token.isDelimiter = true;
      return;
    case 44: 
      this.token.tokenString = ",";
      this.token.tokenType = 824;
      this.currentPosition += 1;
      this.token.isDelimiter = true;
      return;
    case 42: 
    ...
    case 61: 
      this.token.tokenString = "=";
      this.token.tokenType = 417;
      this.currentPosition += 1;
      this.token.isDelimiter = true;
      return;
    case 59: 
      this.token.tokenString = ";";
      this.token.tokenType = 841;
      this.currentPosition += 1;
      this.token.isDelimiter = true;
      return;
    case 43: 
      this.token.tokenString = "+";
      this.token.tokenType = 837;
      this.currentPosition += 1;
      this.token.isDelimiter = true;
      return;
    case 58: 
    ...
    case 60: 
      ...
      {
        this.token.tokenString = "<=";
        this.token.tokenType = 833;
        this.currentPosition += 2;
        this.token.isDelimiter = true;
        return;
      }
      this.token.tokenString = "<";
      this.token.tokenType = 832;
      this.currentPosition += 1;
      this.token.isDelimiter = true;
      return;
    case 62: 
      ...
      {
        this.token.tokenString = ">=";
        this.token.tokenType = 830;
        this.currentPosition += 2;
        this.token.isDelimiter = true;
        return;
      }
      this.token.tokenString = ">";
      this.token.tokenType = 829;
      this.currentPosition += 1;
      this.token.isDelimiter = true;
      return;
    case 124: 
    ...
    case 47: 
      ...
      {
        k = this.sqlString.indexOf('\r', this.currentPosition + 2);
        if (k == -1) {
        ...
        this.token.tokenType = 916;
        this.token.isDelimiter = true;
        return;
      }
      if (charAt(this.currentPosition + 1) == 42)
      {
        k = this.sqlString.indexOf("*/", this.currentPosition + 2);
        if (k == -1)
        {
          this.token.tokenString = this.sqlString.substring(this.currentPosition, this.currentPosition + 2);
          this.token.tokenType = -1;
    ...
    case 39: 
      ...
      i = this.charLiteral ? 1 : 12;
      this.token.dataType = CharacterType.getCharacterType(i, this.token.tokenString.length());
      this.token.tokenType = 911;
      this.token.isDelimiter = true;
      return;
    case 88: 
    ...
    case 117: 
      if ((charAt(this.currentPosition + 1) == 38) && (charAt(this.currentPosition + 2) == 39))
      {
        ...
        i = this.charLiteral ? 1 : 12;
        this.token.dataType = CharacterType.getCharacterType(i, ((String)this.token.tokenValue).length());
        return;
      }
      break;
    case 95: 
      ...
      if (this.token.tokenType != 912)
      {
        this.token.tokenType = 919;
        this.token.isMalformed = true;
        return;
      }
      scanSeparator();
  ...
  private void setIdentifierProperties()
  {
    if (this.token.tokenType == 912)
    {
      ...
      {
        this.token.tokenType = Tokens.getKeywordID(this.token.tokenString, 912);
        if (this.token.tokenType == 912)
        {
          this.token.tokenType = Tokens.getNonKeywordID(this.token.tokenString, 912);
        }
        else
        {
    ...
    else if (this.token.tokenType == 913)
    {
  ...
  public long scanIntervalValue(IntervalType paramIntervalType)
  {
    ...
    while (m <= j)
    {
      ...
      {
        i2 = this.intervalString.charAt(k);
        if ((i2 >= 48) && (i2 <= 57))
        {
          int i3 = i2 - 48;
          l2 *= 10L;
      ...
      if (i1 != 0)
      {
        if (m == i)
        {
          if ((!paramIntervalType.defaultPrecision) && (n > paramIntervalType.precision)) {
  ...
  public synchronized Number convertToNumber(String paramString, NumberType paramNumberType)
  {
    ...
    if ((!this.hasNonSpaceSeparator) && (this.token.tokenType == 911) && ((this.token.tokenValue instanceof Number)))
    {
  ...
  {
    return convertToBinary(paramString, false);
  }
  
  public synchronized BinaryData convertToBinary(String paramString, boolean paramBoolean)
  {
    int i = 1;
    int j = 0;
    reset(paramString);
    ...
    if ((paramBoolean) && (this.byteOutputStream.size() != 16))
    {
      this.token.tokenType = 922;
      this.token.isMalformed = true;
    }
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\Scanner.class
