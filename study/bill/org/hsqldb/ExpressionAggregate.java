  ...
  extends Expression
{
  ...
  public boolean equals(Expression paramExpression)
  {
    if ((paramExpression instanceof ExpressionAggregate))
    {
      ...
      return (super.equals(paramExpression)) && (this.isDistinctAggregate == localExpressionAggregate.isDistinctAggregate);
    }
    return false;
  }
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\ExpressionAggregate.class
