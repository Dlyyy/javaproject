  ...
  extends RowOutputBase
{
  ...
  public void writeSize(int paramInt)
  {
    ...
    {
      writeIntData(paramInt, this.sizePosition);
    }
    this.storageSize = paramInt;
  }
  ...
  protected void writeDecimal(BigDecimal paramBigDecimal, Type paramType)
  {
    ...
    BigInteger localBigInteger = paramBigDecimal.unscaledValue();
  ...
  protected void writeArray(Object[] paramArrayOfObject, Type paramType)
  {
    ...
    for (int i = 0; i < paramArrayOfObject.length; i++) {
      writeData(paramArrayOfObject[i], paramType);
    }
  }
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\rowio\RowOutputBinary.class
