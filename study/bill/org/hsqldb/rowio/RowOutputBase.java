  ...
  implements RowOutputInterface
{
  ...
  public void writeData(int paramInt, Type[] paramArrayOfType, Object[] paramArrayOfObject, HashMappedList paramHashMappedList, int[] paramArrayOfInt)
  {
    ...
    for (int k = 0; k < j; k++)
    {
      ...
      writeData(localObject, localType);
    }
  }
  
  public void writeData(Object paramObject, Type paramType)
  {
    if (paramObject == null)
    {
      writeNull(paramType);
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\rowio\RowOutputBase.class
