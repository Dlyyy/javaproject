...
public class SessionData
{
    ...
    try
    {
      ...
      case 8: 
        ...
        else
        {
          ...
          this.database.lobManager.setCharsForNewClob(l1, localCountdownInputStream, paramResultLob.getBlockLength());
        }
        break;
      case 2: 
      ...
      case 4: 
        ...
        localResult = this.database.lobManager.setChars(l1, paramResultLob.getOffset(), (char[])localObject, (int)l2);
      }
    }
  ...
  private void allocateClobSegments(long paramLong1, long paramLong2, Reader paramReader)
    throws IOException
  {
    int i = this.session.getStreamBlockSize();
    ...
    for (;;)
    {
      ...
      Result localResult = this.database.lobManager.setChars(paramLong1, l, arrayOfChar, localCharArrayWriter.size());
  ...
  {
    File localFile = getFile(paramString1);
    ...
    try
    {
      ...
      InputStreamReader localInputStreamReader = new InputStreamReader(localFileInputStream, paramString2);
      allocateClobSegments(localClobDataID1.getId(), 0L, localInputStreamReader);
  ...
  private File getFile(String paramString)
  {
    ...
    String str = this.database.logger.getSecurePath(paramString, false, false);
    if (str == null) {
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\SessionData.class
