  ...
  extends Expression
{
  ...
  public HsqlList resolveColumnReferences(Session paramSession, RangeGroup paramRangeGroup, int paramInt, RangeGroup[] paramArrayOfRangeGroup, HsqlList paramHsqlList, boolean paramBoolean)
  {
    ...
    if (paramRangeGroup.getRangeVariables().length > 0)
    {
      this.rangeGroups = paramArrayOfRangeGroup;
      this.rangeGroup = paramRangeGroup;
    }
  ...
  public boolean equals(Expression paramExpression)
  {
    if ((paramExpression instanceof ExpressionArrayAggregate))
    {
      ...
      return (super.equals(paramExpression)) && (this.opType == paramExpression.opType) && (this.exprSubType == paramExpression.exprSubType) && (this.isDistinctAggregate == localExpressionArrayAggregate.isDistinctAggregate) && (this.separator.equals(localExpressionArrayAggregate.separator)) && (this.condition.equals(localExpressionArrayAggregate.condition));
    }
    return false;
  }
  ...
  public Object getAggregatedValue(Session paramSession, Object paramObject)
  {
    ...
    case 83: 
      ...
      for (i = 0; i < arrayOfObject.length; i++)
      {
        ...
        localObject4 = (String)Type.SQL_VARCHAR.convertToType(paramSession, localObject3, this.exprType);
    ...
    case 85: 
      ...
      if (i != 0)
      {
        ...
        localObject4 = this.dataType.add(paramSession, localObject2, localObject3, this.dataType);
        return this.dataType.divide(paramSession, localObject4, Integer.valueOf(2));
      }
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\ExpressionArrayAggregate.class
