  ...
  extends SchemaObject
{
  ...
  public abstract long getNodeCount(Session paramSession, PersistentStore paramPersistentStore);
  ...
  public abstract RowIterator firstRow(Session paramSession, PersistentStore paramPersistentStore, int paramInt, boolean[] paramArrayOfBoolean);
  
  public abstract RowIterator lastRow(Session paramSession, PersistentStore paramPersistentStore, int paramInt, boolean[] paramArrayOfBoolean);
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\index\Index.class
