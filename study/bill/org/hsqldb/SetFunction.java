...
public class SetFunction
{
  ...
  Object getValue(Session paramSession)
  {
    ...
    case 75: 
      ...
      case 5: 
        ...
        return Long.valueOf(this.currentLong / this.count);
      case 25: 
      ...
      case 10: 
        ...
        if (NumberType.compareToLongLimits(localBigInteger) != 0) {
  ...
  void addLong(long paramLong)
  {
    if (paramLong != 0L) {
      ...
      {
        long l = (paramLong ^ 0xFFFFFFFFFFFFFFFF) + 1L;
        this.hi -= (l >> 32);
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\SetFunction.class
