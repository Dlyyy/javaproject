  ...
  extends Expression
{
  ...
  void resolveTypesForConcat(Session paramSession, Expression paramExpression)
  {
    ...
    if (this.nodes[0].dataType.isArrayType())
    {
      ...
      if (((Expression)localObject).opType == 95)
      {
  ...
  public Object getValue(Session paramSession)
  {
    ...
    case 5: 
      ...
      return localObject1;
    case 31: 
      return this.dataType.negate(this.nodes[0].getValue(paramSession, this.nodes[0].dataType));
    }
    ...
    {
    case 32: 
      return this.dataType.add(paramSession, localObject1, localObject2, this.nodes[1].dataType);
    case 33: 
      return this.dataType.subtract(paramSession, localObject1, localObject2, this.nodes[1].dataType);
    case 34: 
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\ExpressionArithmetic.class
