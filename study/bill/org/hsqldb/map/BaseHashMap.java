...
public class BaseHashMap
{
    ...
    throws IllegalArgumentException
  {
    ...
    this.isLastAccessCount = paramBoolean;
    if (paramBoolean) {
  ...
  protected Object addOrRemoveObject(Object paramObject, long paramLong, boolean paramBoolean)
  {
    ...
    while (k >= 0)
    {
      if (this.comparator.longKey(this.objectKeyTable[k]) == paramLong)
      {
        localObject = this.objectKeyTable[k];
        break;
      }
  ...
  {
    return ArrayCounter.rank(this.accessTable, this.hashIndex.newNodePointer, paramInt1, this.accessMin, this.accessCount, paramInt2);
  }
  
  protected void setAccessCountFloor(int paramInt)
  {
  ...
  protected void resetAccessCount()
  {
    ...
    double d = this.accessMin / this.accessCount;
    if (d < 0.5D) {
      d = 0.5D;
    }
    for (;;)
    {
      ...
      if (this.accessTable[i] < this.accessMin) {
        ...
        this.accessTable[i] = ((int)((this.accessTable[i] - this.accessMin) * d));
      }
    }
    this.accessCount = ((int)((this.accessCount - this.accessMin) * d));
    this.accessMin = 0;
  }
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\map\BaseHashMap.class
