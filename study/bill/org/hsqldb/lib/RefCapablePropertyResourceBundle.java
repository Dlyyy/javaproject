...
public class RefCapablePropertyResourceBundle
{
  ...
  public String getExpandedString(String paramString, int paramInt)
  {
    ...
    while (localMatcher.find())
    {
      ...
      if (localObject != null) {
        str3 = str3 == null ? "" : ((String)localObject).replaceAll("\\Q$" + str2 + "\\E\\b", Matcher.quoteReplacement(str3));
      }
      if (str3 == null) {
        switch (paramInt)
        {
  ...
  public String posSubst(String paramString, String[] paramArrayOfString, int paramInt)
  {
    ...
    while (localMatcher.find())
    {
      ...
      if (localObject != null) {
        str = str == null ? "" : ((String)localObject).replaceAll("\\Q%" + (j + 1) + "\\E\\b", Matcher.quoteReplacement(str));
      }
      if (str == null) {
        switch (paramInt)
        {
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\lib\RefCapablePropertyResourceBundle.class
