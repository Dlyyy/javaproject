  ...
  implements HsqlList, Set
{
  ...
  public void addAll(OrderedHashSet paramOrderedHashSet)
  {
    int i = 0;
    int j = paramOrderedHashSet.size();
    while (i < j)
    {
      add(paramOrderedHashSet.get(i));
      i++;
    }
  }
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\lib\OrderedHashSet.class
