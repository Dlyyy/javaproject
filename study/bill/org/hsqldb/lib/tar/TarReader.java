...
public class TarReader
{
    ...
    throws IOException, TarMalformatException
  {
    ...
    if (l > 2147483647L) {
      throw new TarMalformatException(RB.pif_data_toobig.getString(Long.toString(l), Integer.MAX_VALUE));
    }
    int j = (int)(l / 512L);
    int k = (int)(l % 512L);
  ...
  protected static class TarEntryHeader
  {
    ...
    {
      StringBuffer localStringBuffer = new StringBuffer(this.sdf.format(Long.valueOf(this.modTime * 1000L)) + ' ');
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\lib\tar\TarReader.class
