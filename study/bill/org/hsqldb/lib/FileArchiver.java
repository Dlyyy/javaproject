...
public class FileArchiver
{
  ...
  public static void copyFile(String paramString1, String paramString2, FileAccess paramFileAccess)
    throws IOException
  {
      ...
      try
      {
        ...
        if (localObject1 != null)
        {
          ...
          if ((localObject2 instanceof FileOutputStream)) {
            paramFileAccess.getFileSync((OutputStream)localObject2).sync();
          }
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\lib\FileArchiver.class
