...
public class ArrayUtil
{
  ...
  {
    if ((paramInt3 >= paramInt2) || (paramInt4 == 0)) {
      return;
    }
  ...
  {
    return compare(paramArrayOfByte1, 0, paramArrayOfByte1.length, paramArrayOfByte2, paramArrayOfByte2.length);
  }
  
  public static int compare(byte[] paramArrayOfByte1, int paramInt1, int paramInt2, byte[] paramArrayOfByte2, int paramInt3)
  {
    int i = paramInt2;
    if (i > paramInt3) {
      i = paramInt3;
    ...
    for (int j = 0; j < i; j++) {
      if (paramArrayOfByte1[(paramInt1 + j)] != paramArrayOfByte2[j]) {
        return (paramArrayOfByte1[(paramInt1 + j)] & 0xFF) > (paramArrayOfByte2[j] & 0xFF) ? 1 : -1;
      }
    }
    if (paramInt2 == paramInt3) {
      return 0;
    }
    return paramInt2 < paramInt3 ? -1 : 1;
  }
  ...
  public static long getBinaryNormalisedCeiling(long paramLong)
  {
    for (long l = 2L; l < paramLong; l <<= 1) {}
    return l;
  }
  ...
  {
    int i = getTwoPowerScale(paramInt);
    if (i == 0) {
      return 0;
    }
    return 1 << i;
  ...
  public static int getTwoPowerScale(int paramInt)
  {
    int i = 0;
    if (paramInt == 0) {
      return 0;
  ...
  public static int cdiv(int paramInt1, int paramInt2)
  {
    int i = paramInt1 / paramInt2;
  ...
  public static long cdiv(long paramLong1, long paramLong2)
  {
    long l = paramLong1 / paramLong2;
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\lib\ArrayUtil.class
