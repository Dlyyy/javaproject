  ...
  implements Cloneable
{
  ...
  void setPattern(Session paramSession, Object paramObject1, Object paramObject2, boolean paramBoolean)
  {
    ...
    for (int m = 0; m < i; m++)
    {
      int n = getChar(paramSession, paramObject1, m);
      if (j == 0)
      {
  ...
  Object getRangeHigh(Session paramSession)
  {
    ...
    return this.dataType.concat(paramSession, localObject, "￿");
  }
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\Like.class
