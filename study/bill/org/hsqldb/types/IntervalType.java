  ...
  extends DTIType
{
  ...
  public Object convertToType(SessionInterface paramSessionInterface, Object paramObject, Type paramType)
  {
    ...
    case 8: 
    case 25: 
      if (((paramObject instanceof BigDecimal)) && (NumberType.compareToLongLimits((BigDecimal)paramObject) != 0)) {
        throw Error.error(3435);
      }
    ...
    case 101: 
      l = ((IntervalMonthData)paramObject).units / 12 * 12L;
  ...
  public Object subtract(Session paramSession, Object paramObject1, Object paramObject2, Type paramType)
  {
    ...
    case 107: 
      ...
      if (((paramObject1 instanceof TimestampData)) && ((paramObject2 instanceof TimestampData)))
      {
        ...
        long l3 = DateTimeType.subtractMonths(paramSession, (TimestampData)paramObject1, (TimestampData)paramObject2, bool);
  ...
  private Object multiplyOrDivide(Object paramObject1, Object paramObject2, boolean paramBoolean)
  {
    ...
    if (NumberType.compareToLongLimits(localBigDecimal3) != 0) {
      throw Error.error(3435);
    }
    if (bool)
    {
  ...
  public double convertToDoubleStartUnits(Object paramObject)
  {
    ...
    case 101: 
    case 102: 
      double d1 = ((IntervalMonthData)paramObject).units;
      return d1 / DTIType.yearToSecondFactors[this.startPartIndex];
    case 103: 
    case 104: 
    case 105: 
    case 106: 
      double d2 = ((IntervalSecondData)paramObject).units;
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\types\IntervalType.class
