  ...
  implements SchemaObject, Cloneable
{
  ...
  public int compare(Session paramSession, Object paramObject1, Object paramObject2, int paramInt)
  {
    ...
    return compare(paramSession, paramObject1, paramObject2);
  }
  ...
  {
    return this.typeComparisonGroup == paramType.typeComparisonGroup;
  }
  ...
  {
    int i = typeNames.get(paramString, Integer.MIN_VALUE);
    if (i == Integer.MIN_VALUE) {
      i = typeAliases.get(paramString, Integer.MIN_VALUE);
    }
    return i;
  }
  ...
  static
  {
    ...
    jdbcConvertTypes.put(856, SQL_CHAR_DEFAULT);
    jdbcConvertTypes.put(879, SQL_VARCHAR_DEFAULT);
    jdbcConvertTypes.put(866, SQL_VARCHAR_DEFAULT);
    jdbcConvertTypes.put(870, SQL_VARCHAR_DEFAULT);
    jdbcConvertTypes.put(858, SQL_DATE);
    jdbcConvertTypes.put(875, SQL_TIME);
    jdbcConvertTypes.put(876, SQL_TIMESTAMP);
    jdbcConvertTypes.put(877, TINYINT);
    jdbcConvertTypes.put(874, SQL_SMALLINT);
    jdbcConvertTypes.put(863, SQL_INTEGER);
    jdbcConvertTypes.put(851, SQL_BIGINT);
    jdbcConvertTypes.put(871, SQL_DOUBLE);
    jdbcConvertTypes.put(862, SQL_DOUBLE);
    jdbcConvertTypes.put(861, SQL_DOUBLE);
    jdbcConvertTypes.put(869, SQL_NUMERIC);
    jdbcConvertTypes.put(859, SQL_DECIMAL);
    jdbcConvertTypes.put(855, SQL_BOOLEAN);
    jdbcConvertTypes.put(852, SQL_BINARY_DEFAULT);
    jdbcConvertTypes.put(878, SQL_VARBINARY_DEFAULT);
    jdbcConvertTypes.put(864, SQL_VARBINARY_DEFAULT);
    jdbcConvertTypes.put(857, SQL_CLOB);
    jdbcConvertTypes.put(854, SQL_BLOB);
    jdbcConvertTypes.put(853, SQL_BIT);
  }
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\types\Type.class
