  ...
  extends Type
{
  ...
  public int canMoveFrom(Type paramType)
  {
    ...
    case 14: 
    case 60: 
      if ((paramType.typeCode == this.typeCode) || (paramType.typeCode == -11)) {
        return this.precision == paramType.precision ? 0 : -1;
      }
      return -1;
    case 15: 
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\types\BinaryType.class
