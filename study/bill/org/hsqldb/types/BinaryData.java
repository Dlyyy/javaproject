  ...
  implements BlobData
{
  ...
  public BinaryData(byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    this.bitLength = (paramArrayOfByte.length * 8L);
  }
  ...
  public BinaryData(long paramLong, DataInput paramDataInput)
  {
    ...
    this.bitLength = (this.data.length * 8L);
    try
    {
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\types\BinaryData.class
