  ...
  extends Type
{
  ...
  public Type getCombinedType(Session paramSession, Type paramType, int paramInt)
  {
    ...
    case 32: 
      ...
      l = getDecimalPrecision() - this.scale > ((NumberType)paramType).getDecimalPrecision() - paramType.scale ? getDecimalPrecision() - this.scale : ((NumberType)paramType).getDecimalPrecision() - paramType.scale;
      l += 1L;
      break;
    case 35: 
      l = getDecimalPrecision() - this.scale + paramType.scale;
      i = this.scale > paramType.scale ? this.scale : paramType.scale;
      ...
      break;
    case 34: 
      l = getDecimalPrecision() - this.scale + ((NumberType)paramType).getDecimalPrecision() - paramType.scale;
  ...
  public int compare(Session paramSession, Object paramObject1, Object paramObject2)
  {
    ...
    case 5: 
      ...
      if ((paramObject2 instanceof BigDecimal))
      {
        ...
        return localBigDecimal1.compareTo((BigDecimal)paramObject2);
      }
    case 25: 
      ...
      if ((paramObject2 instanceof Double))
      {
        ...
        BigDecimal localBigDecimal4 = BigDecimal.valueOf(((Double)paramObject2).doubleValue());
        return localBigDecimal2.compareTo(localBigDecimal4);
      }
      if ((paramObject2 instanceof BigDecimal))
      {
        localBigDecimal2 = convertToDecimal(paramObject1);
        return localBigDecimal2.compareTo((BigDecimal)paramObject2);
      }
    case 6: 
    case 7: 
    case 8: 
    ...
    case 3: 
      ...
      return ((BigDecimal)paramObject1).compareTo(localBigDecimal3);
    }
    throw Error.runtimeError(201, "NumberType");
  }
  ...
  public int compareToTypeRange(Object paramObject)
  {
    ...
    {
      int j = compareToLongLimits((BigDecimal)paramObject);
      if (j != 0) {
        return j;
      }
      i = 1;
    ...
    if (i != 0)
    {
      ...
      case 3: 
        ...
        int i1 = JavaSystem.precision(localBigDecimal);
        if (n < 0)
        {
          i1 -= n;
          n = 0;
        }
        return this.precision - this.scale >= i1 - n ? 0 : localBigDecimal.signum();
      default: 
        return 0;
      }
      if (m < l) {
  ...
  public Object modulo(Session paramSession, Object paramObject1, Object paramObject2, Type paramType)
  {
    ...
    paramObject1 = truncate(paramObject1, this.scale);
    paramObject2 = ((NumberType)paramType).truncate(paramObject2, paramType.scale);
    ...
    case 7: 
    case 8: 
      localObject = truncate(localObject, 0);
    }
    localObject = multiply(localObject, paramObject2);
    localObject = subtract(paramSession, paramObject1, localObject, this);
    return paramType.convertToType(null, localObject, this);
  }
  ...
  public static int compareToLongLimits(BigDecimal paramBigDecimal)
  {
    if (MIN_LONG.compareTo(paramBigDecimal) > 0) {
      return -1;
    }
    if (MAX_LONG.compareTo(paramBigDecimal) < 0) {
      return 1;
    }
    return 0;
  }
  
  public static int compareToLongLimits(BigInteger paramBigInteger)
  {
    if (MIN_LONG_BI.compareTo(paramBigInteger) > 0) {
      return -1;
    }
    if (MAX_LONG_BI.compareTo(paramBigInteger) < 0) {
      return 1;
    }
    return 0;
  }
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\types\NumberType.class
