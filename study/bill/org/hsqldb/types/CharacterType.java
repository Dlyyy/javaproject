  ...
  extends Type
{
  ...
  public Type getCombinedType(Session paramSession, Type paramType, int paramInt)
  {
    ...
    return getCharacterType(((Type)localObject).typeCode, l, this.collation);
  }
  ...
  public Object convertToTypeLimits(SessionInterface paramSessionInterface, Object paramObject)
  {
    ...
    case 1: 
      ...
      if (i > this.precision)
      {
        if (getRightTrimSize((String)paramObject, ' ') <= this.precision) {
    ...
    case 12: 
      ...
      return paramObject;
    case 40: 
      ClobData localClobData = (ClobData)paramObject;
      if (localClobData.length(paramSessionInterface) > this.precision) {
        throw Error.error(3401);
      }
      return paramObject;
    }
  ...
  public Object convertToDefaultType(SessionInterface paramSessionInterface, Object paramObject)
  {
    ...
    if ((paramObject instanceof Boolean)) {
      ...
      str = HsqlDateTime.getTimestampString(((java.util.Date)paramObject).getTime());
    } else {
      throw Error.error(5561);
    }
    return str;
  ...
  public Object trim(SessionInterface paramSessionInterface, Object paramObject, char paramChar, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    int j = 0;
    if (paramBoolean1) {
      while ((j < i) && (str.charAt(j) == paramChar)) {
        j++;
      }
    }
    if ((j != 0) || (i != str.length())) {
  ...
  public Type getCharacterType(long paramLong)
  {
    ...
    return getCharacterType(this.typeCode, paramLong, this.collation);
  }
  
  public static int getRightTrimSize(String paramString, char paramChar)
  {
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\types\CharacterType.class
