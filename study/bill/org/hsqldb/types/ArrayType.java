  ...
  extends Type
{
  ...
  public Object convertJavaToSQL(SessionInterface paramSessionInterface, Object paramObject)
  {
    ...
    if (i != 0)
    {
      ...
      {
        Object localObject = this.dataType.convertJavaToSQL(paramSessionInterface, arrayOfObject1[j]);
        arrayOfObject2[j] = this.dataType.convertToTypeLimits(paramSessionInterface, localObject);
      }
      return arrayOfObject2;
    }
  ...
  public int canMoveFrom(Type paramType)
  {
    ...
    if (this.maxCardinality >= ((ArrayType)paramType).maxCardinality) {
      return this.dataType.canMoveFrom(paramType);
    }
    if (this.dataType.canMoveFrom(paramType) == -1) {
      return -1;
    }
    return 1;
  }
  ...
  public Type getCombinedType(Session paramSession, Type paramType, int paramInt)
  {
    ...
    if (localArrayType.maxCardinality == Integer.MAX_VALUE) {
      return localArrayType;
    }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((paramObject instanceof ArrayType)) {
      return (super.equals(paramObject)) && (this.maxCardinality == ((ArrayType)paramObject).maxCardinality) && (this.dataType.equals(((ArrayType)paramObject).dataType));
    }
    return false;
  }
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\types\ArrayType.class
