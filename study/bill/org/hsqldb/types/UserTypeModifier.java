...
public class UserTypeModifier
{
  ...
  public String getSQL()
  {
    ...
    if (this.schemaObjectType == 12)
    {
      ...
      {
        Collation localCollation = this.dataType.getCollation();
        if (localCollation.isObjectCollation()) {
          localStringBuffer.append(' ').append(localCollation.getCollateSQL());
        }
      }
    }
    else
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\types\UserTypeModifier.class
