  ...
  extends Reader
{
    ...
    throws IOException
  {
    ...
    for (int i = paramInt1; (i < paramInt1 + paramInt2) && (i < paramArrayOfChar.length); i++) {
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\types\ClobInputStream.class
