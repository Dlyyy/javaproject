  ...
  extends Type
{
  ...
  public String convertToSQLString(Object paramObject)
  {
    ...
    for (int i = 0; i < arrayOfObject.length; i++)
    {
      ...
      String str = this.dataTypes[i].convertToSQLString(arrayOfObject[i]);
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((paramObject instanceof Type))
    {
      ...
      for (int i = 0; i < this.dataTypes.length; i++) {
        if (!this.dataTypes[i].equals(arrayOfType[i])) {
          return false;
        }
      }
      return true;
  ...
  public static String convertToSQLString(Object[] paramArrayOfObject, Type[] paramArrayOfType, int paramInt)
  {
    ...
    for (int i = 0; i < paramArrayOfObject.length; i++)
    {
      ...
      {
        localStringBuffer.append(str.substring(0, paramInt - 4));
        localStringBuffer.append(" ...");
      }
      else
      {
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\types\RowType.class
