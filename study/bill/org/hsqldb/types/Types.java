...
public class Types
{
  ...
  public static final int[][] ALL_TYPES = { { 50, 1 }, { 25, 1 }, { 60, 1 }, { 61, 1 }, { 30, 1 }, { 16, 1 }, { 1, 1 }, { 40, 1 }, { 70, 1 }, { 91, 1 }, { 3, 1 }, { 2001, 1 }, { 8, 1 }, { 6, 1 }, { 4, 1 }, { 2000, 1 }, { -8, 1 }, { 2007, 1 }, { 0, 1 }, { 2, 1 }, { -9, 1 }, { 1111, 1 }, { 7, 1 }, { 20, 1 }, { 2008, 1 }, { 5, 1 }, { 2002, 1 }, { 92, 1 }, { 93, 1 }, { -6, 1 }, { 12, 1 }, { 137, 1 } };
  ...
  public static Type getParameterSQLType(Class paramClass)
  {
    ...
    int i = javaTypeNumbers.get(str, Integer.MIN_VALUE);
    ...
    if (paramClass.isArray())
    {
      ...
      i = javaTypeNumbers.get(str, Integer.MIN_VALUE);
      if (i == 0) {
        return null;
      }
      if (i != Integer.MIN_VALUE) {
  ...
  static
  {
    ...
    javaTypeNumbers.put("java.lang.CharSequence", 12);
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\types\Types.class
