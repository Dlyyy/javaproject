  ...
  extends Expression
{
  ...
  public String getSQL()
  {
    ...
    case 65: 
      ...
      return localStringBuffer.toString();
    case 66: 
      localStringBuffer.append(str1).append(' ').append("MATCH").append(' ').append(492).append(str2);
      return localStringBuffer.toString();
    case 67: 
      localStringBuffer.append(str1).append(' ').append("MATCH").append(' ').append(125).append(str2);
      return localStringBuffer.toString();
    case 68: 
      localStringBuffer.append(str1).append(' ').append("MATCH").append(' ').append(315).append(str2);
      return localStringBuffer.toString();
    case 69: 
      localStringBuffer.append(str1).append(' ').append("MATCH").append(' ').append(315).append(' ').append(492).append(str2);
      return localStringBuffer.toString();
    case 70: 
      localStringBuffer.append(str1).append(' ').append("MATCH").append(' ').append(315).append(' ').append(125).append(str2);
      return localStringBuffer.toString();
    case 51: 
    case 52: 
    case 53: 
  ...
  protected String describe(Session paramSession, int paramInt)
  {
    ...
    case 55: 
      ...
      break;
    case 56: 
      localStringBuffer.append("CONTAINS");
      break;
    case 57: 
      localStringBuffer.append("EQUALS");
      break;
    case 58: 
      localStringBuffer.append("OVERLAPS");
      break;
    case 59: 
      localStringBuffer.append("PRECEDES");
      break;
    case 60: 
      localStringBuffer.append("SUCCEEDS");
      break;
    case 2: 
    case 3: 
    case 4: 
  ...
  public void resolveTypes(Session paramSession, Expression paramExpression)
  {
    ...
    case 47: 
      ...
      {
      case 25: 
        localObject = this.nodes[0].nodes;
        Expression localExpression = null;
        for (int j = 0; j < localObject.length; j++)
        {
          ExpressionLogical localExpressionLogical = new ExpressionLogical(47, localObject[j]);
          if (this.opType == 39) {
            localExpressionLogical = new ExpressionLogical(48, localExpressionLogical);
          }
          localExpression = andExpressions(localExpression, localExpressionLogical);
        }
        this.opType = 49;
        this.nodes = localExpression.nodes;
      ...
      default: 
        ...
        if (this.opType == 39)
        {
          localObject = new ExpressionLogical(47, this.nodes[0]);
          this.nodes[0] = localObject;
          this.opType = 48;
          resolveTypes(paramSession, paramExpression);
        }
    ...
    case 61: 
    case 62: 
      resolveTypesForPeriodPredicates(paramSession);
      break;
    case 54: 
  ...
  private void resolveTypesForComparison(Session paramSession, Expression paramExpression)
  {
    ...
    if ((!this.nodes[0].dataType.canCompareDirect(this.nodes[1].dataType)) && (!convertDateTimeLiteral(paramSession, this.nodes[0], this.nodes[1]))) {
    ...
    else if ((paramSession.database.sqlSyntaxDb2) && (this.nodes[0].dataType.typeComparisonGroup == 12))
    {
      if (this.nodes[0].opType == 1) {
        this.nodes[1].dataType.convertToTypeLimits(paramSession, this.nodes[0].valueData);
      }
      if (this.nodes[1].opType == 1) {
        this.nodes[0].dataType.convertToTypeLimits(paramSession, this.nodes[1].valueData);
      }
    }
  }
  ...
  void resolveTypesForPeriodPredicates(Session paramSession)
  {
    if (this.nodes[1].nodes.length == 0)
    {
      Expression[] arrayOfExpression = { this.nodes[1], new ExpressionValue(null, this.nodes[1].dataType) };
      this.nodes[1] = new Expression(25, arrayOfExpression);
  ...
  void resolveTypesForAllAny(Session paramSession)
  {
    ...
    if (this.nodes[1].opType == 26)
    {
      ...
      this.nodes[1].table.prepareTable(paramSession);
    }
  ...
  public Object getValue(Session paramSession)
  {
    ...
    case 56: 
      ...
      boolean bool = this.nodes[1].exprSubType != 57;
      return DateTimeType.contains(paramSession, (Object[])localObject1, this.nodes[0].nodeDataTypes, (Object[])localObject2, this.nodes[1].nodeDataTypes, bool);
    case 57: 
      localObject1 = this.nodes[0].getRowValue(paramSession);
      localObject2 = this.nodes[1].getRowValue(paramSession);
      return DateTimeType.equals(paramSession, (Object[])localObject1, this.nodes[0].nodeDataTypes, (Object[])localObject2, this.nodes[1].nodeDataTypes);
    case 58: 
      localObject1 = this.nodes[0].getRowValue(paramSession);
      localObject2 = this.nodes[1].getRowValue(paramSession);
      if (this.nodes[0].exprSubType == 57) {
      ...
      return DateTimeType.overlapsRelaxed(paramSession, (Object[])localObject1, this.nodes[0].nodeDataTypes, (Object[])localObject2, this.nodes[1].nodeDataTypes);
    case 59: 
      localObject1 = this.nodes[0].getRowValue(paramSession);
      localObject2 = this.nodes[1].getRowValue(paramSession);
      return DateTimeType.precedes(paramSession, (Object[])localObject1, this.nodes[0].nodeDataTypes, (Object[])localObject2, this.nodes[1].nodeDataTypes);
    case 61: 
      localObject1 = this.nodes[0].getRowValue(paramSession);
      localObject2 = this.nodes[1].getRowValue(paramSession);
      return DateTimeType.immediatelyPrecedes(paramSession, (Object[])localObject1, this.nodes[0].nodeDataTypes, (Object[])localObject2, this.nodes[1].nodeDataTypes);
    case 62: 
      localObject1 = this.nodes[0].getRowValue(paramSession);
      localObject2 = this.nodes[1].getRowValue(paramSession);
      return DateTimeType.immediatelySucceeds(paramSession, (Object[])localObject1, this.nodes[0].nodeDataTypes, (Object[])localObject2, this.nodes[1].nodeDataTypes);
    case 60: 
      localObject1 = this.nodes[0].getRowValue(paramSession);
      localObject2 = this.nodes[1].getRowValue(paramSession);
      return DateTimeType.succeeds(paramSession, (Object[])localObject1, this.nodes[0].nodeDataTypes, (Object[])localObject2, this.nodes[1].nodeDataTypes);
    case 54: 
  ...
  private Boolean testMatchCondition(Session paramSession)
  {
    ...
    case 23: 
      ...
      if ((i != 0) && ((this.opType == 66) || (this.opType == 69)))
      {
        k = 0;
  ...
  private Boolean getAllAnyValue(Session paramSession, Object[] paramArrayOfObject, TableDerived paramTableDerived)
  {
    ...
    Index localIndex = localTableDerived.getFullIndex(paramSession);
    ...
    case 52: 
      ...
      if (this.opType == 46) {
        localRowIterator = localIndex.firstRow(paramSession, localPersistentStore, 0, null);
      } else {
      ...
      localRow2 = localIndex.lastRow(paramSession, localPersistentStore, 0, null).getNextRow();
  ...
  {
    for (int i = 0; i < this.nodes.length; i++) {
      this.nodes[i].getJoinRangeVariables(paramArrayOfRangeVariable, paramHsqlList);
    }
  }
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\ExpressionLogical.class
