  ...
  implements SchemaObject
{
  ...
  {
    NumberSequence localNumberSequence = new NumberSequence(this.name, this.dataType);
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\NumberSequence.class
