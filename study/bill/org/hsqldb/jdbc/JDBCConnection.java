  ...
  implements Connection
{
    ...
    throws SQLException
  {
    ...
    {
      JDBCUtil.throwError(localHsqlException);
    }
    ...
    throws SQLClientInfoException
  {
    ...
    localSQLClientInfoException.initCause(JDBCUtil.notSupported());
    ...
    throws SQLClientInfoException
  {
    ...
    SQLClientInfoException localSQLClientInfoException = new SQLClientInfoException();
    if (this.isClosed) {
      localSQLClientInfoException.initCause(JDBCUtil.connectionClosedException());
    } else {
      localSQLClientInfoException.initCause(JDBCUtil.notSupported());
    }
    throw localSQLClientInfoException;
    ...
    throws SQLException
  {
    ...
    boolean bool1 = ("hsqls://".equals(str3)) || ("https://".equals(str3));
    ...
    try
    {
      ...
      else if (("hsql://".equals(str3)) || ("hsqls://".equals(str3)))
      {
        this.sessionProxy = new ClientConnection(str4, i, str5, str6, bool1, bool2, str1, str2, j);
        this.isNetConn = true;
      }
      else if (("http://".equals(str3)) || ("https://".equals(str3)))
      {
        this.sessionProxy = new ClientConnectionHTTP(str4, i, str5, str6, bool1, bool2, str1, str2, j);
        this.isNetConn = true;
      }
      else
      {
  ...
  private void setLocalVariables()
  {
    ...
    if (this.isStoreLiveObject)
    {
      String str = this.connProperties.getProperty("connection_type");
      if (!"mem:".equals(str)) {
    ...
    throws SQLException
  {
    ...
    {
      throw JDBCUtil.sqlException(1305, localHsqlException.getMessage(), localHsqlException);
    }
  }
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\jdbc\JDBCConnection.class
