  ...
  implements PreparedStatement
{
    ...
    throws SQLException
  {
    ...
    {
      throw JDBCUtil.sqlException(401, localIOException.toString(), localIOException);
    }
    ...
    throws SQLException
  {
    ...
    if (l > 2147483647L)
    {
      ...
      throw JDBCUtil.sqlException(422, (String)localObject);
    }
    try
    {
    ...
    {
      throw JDBCUtil.sqlException(422, localThrowable.toString(), localThrowable);
    }
  }
    ...
    throws SQLException
  {
    ...
    {
      throw JDBCUtil.sqlException(401, localThrowable.toString(), localThrowable);
    }
  }
    ...
    throws SQLException
  {
    ...
    {
      arrayOfObject1 = ((JDBCArray)paramArray).getArrayInternal();
    }
    else
    {
    ...
    throws SQLException
  {
    ...
    long l = HsqlDateTime.convertMillisFromCalendar(this.session.getCalendarGMT(), localCalendar, paramDate.getTime());
    l = HsqlDateTime.getNormalisedDate(this.session.getCalendarGMT(), l);
    switch (localType.typeCode)
    {
    case 91: 
    case 93: 
    ...
    throws SQLException
  {
    ...
    int j = 0;
    Calendar localCalendar = paramCalendar == null ? this.session.getCalendar() : paramCalendar;
    l = HsqlDateTime.convertMillisFromCalendar(this.session.getCalendarGMT(), localCalendar, l);
    l = HsqlDateTime.convertToNormalisedTime(l, this.session.getCalendarGMT());
    switch (localType.typeCode)
    {
    case 92: 
      break;
    ...
    throws SQLException
  {
    ...
    int j = 0;
    Calendar localCalendar = paramCalendar == null ? this.session.getCalendar() : paramCalendar;
    l1 = HsqlDateTime.convertMillisFromCalendar(this.session.getCalendarGMT(), localCalendar, l1);
    long l2;
    switch (localType.typeCode)
    {
    case 95: 
      j = HsqlDateTime.getZoneMillis(localCalendar, l1);
    case 93: 
      l2 = l1 / 1000L;
      if ((l2 < DateTimeType.epochSeconds) || (l2 > DateTimeType.limitSeconds)) {
        throw Error.error(3408);
      }
      this.parameterValues[i] = new TimestampData(l2, paramTimestamp.getNanos(), j / 1000);
      break;
    case 92: 
      l1 = HsqlDateTime.getNormalisedTime(this.session.getCalendarGMT(), l1);
      this.parameterValues[i] = new TimeData((int)(l1 / 1000L), paramTimestamp.getNanos(), 0);
      break;
    case 94: 
      l1 = HsqlDateTime.getNormalisedTime(this.session.getCalendarGMT(), l1);
      j = HsqlDateTime.getZoneMillis(localCalendar, l1);
      this.parameterValues[i] = new TimeData((int)(l1 / 1000L), paramTimestamp.getNanos(), j / 1000);
      break;
    case 91: 
      l1 = HsqlDateTime.getNormalisedDate(this.session.getCalendarGMT(), l1);
      l2 = l1 / 1000L;
      if ((l2 < DateTimeType.epochSeconds) || (l2 > DateTimeType.limitSeconds)) {
        throw Error.error(3408);
      }
      this.parameterValues[i] = new TimestampData(l2);
      break;
    default: 
      throw JDBCUtil.sqlException(5561);
    }
    ...
    throws SQLException
  {
    ...
    this.isClosed = true;
    if (localObject != null) {
      throw JDBCUtil.sqlException((HsqlException)localObject);
    }
  }
    ...
    throws SQLException
  {
    ...
    {
      throw JDBCUtil.sqlException(422, null, localIOException);
    }
  }
  ...
  {
    checkClosed();
    String str = this.resultOut.getMainString();
    Result localResult1 = Result.newCancelRequest(this.statementID, str);
    try
    {
      Result localResult2 = this.connection.sessionProxy.cancel(localResult1);
    }
    catch (HsqlException localHsqlException)
    {
      throw JDBCUtil.sqlException(localHsqlException);
    ...
    throws HsqlException, SQLException
  {
    ...
    if (localResult1.mode == 2) {
      throw JDBCUtil.sqlException(localResult1);
    }
    this.rootWarning = null;
    ...
    while (localResult2.getChainedResult() != null)
    {
      ...
      {
        SQLWarning localSQLWarning = JDBCUtil.sqlWarning(localResult2);
    ...
    throws SQLException
  {
    ...
    case 1111: 
      try
      {
        ...
        {
          paramObject = new JavaObjectDataInternal(paramObject);
          break label886;
        }
      ...
      {
        JDBCUtil.throwError(localHsqlException1);
      }
    ...
    case 15: 
      ...
      {
        JDBCUtil.throwError(localHsqlException2);
      }
      JDBCUtil.throwError(Error.error(5563));
    case -11: 
    case 60: 
    case 61: 
      ...
      {
        paramObject = BinaryUUIDType.getBinary((UUID)paramObject);
      }
      else
      {
        try
        ...
        {
          JDBCUtil.throwError(localHsqlException3);
        }
        JDBCUtil.throwError(Error.error(5563));
      }
      break;
    ...
    case 95: 
      ...
      {
        JDBCUtil.throwError(localHsqlException4);
      }
    case -6: 
    case 2: 
    case 3: 
    ...
    case 25: 
      ...
      {
        JDBCUtil.throwError(localHsqlException5);
      }
    case 12: 
      if ((paramObject instanceof String)) {
        break label886;
      ...
      {
        JDBCUtil.throwError(localHsqlException6);
      }
    case 1: 
    ...
    {
      JDBCUtil.throwError(localHsqlException7);
    }
    label886:
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\jdbc\JDBCPreparedStatement.class
