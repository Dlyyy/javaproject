  ...
  implements XAResource
{
  ...
  public void start(Xid paramXid, int paramInt)
    throws XAException
  {
    if ((this.state != XA_STATE_INITIAL) && (this.state != XA_STATE_DISPOSED) && (this.state != XA_STATE_ENDED)) {
      throw new XAException("Invalid XAResource state");
    }
    ...
    try
    {
      ...
      {
        this.originalAutoCommitMode = true;
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\jdbc\pool\JDBCXAResource.class
