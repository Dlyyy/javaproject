  ...
  implements CallableStatement
{
  ...
  public <T> T getObject(String paramString, Class<T> paramClass)
    throws SQLException
  {
    return (T)getObject(findParameterIndex(paramString), paramClass);
  }
    ...
    throws SQLException
  {
    ...
    i = this.parameterNameMap.get(paramString.toUpperCase(Locale.ENGLISH), -1);
    if (i >= 0) {
      return i + 1;
    }
    ...
    throws SQLException
  {
    ...
    if (localType.typeCode != paramType.typeCode) {
      ...
      catch (HsqlException localHsqlException1)
      {
        ...
        throw JDBCUtil.sqlException(localHsqlException2, localHsqlException1);
      }
    }
    return localObject;
  }
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\jdbc\JDBCCallableStatement.class
