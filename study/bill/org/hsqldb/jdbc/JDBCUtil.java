...
{
  static void throwError(HsqlException paramHsqlException)
    throws SQLException
  {
  ...
  public static SQLException sqlException(HsqlException paramHsqlException, Throwable paramThrowable)
  {
  ...
  public static SQLException sqlException(int paramInt)
  {
    return sqlException(Error.error(paramInt));
  }
  
  public static SQLException sqlExceptionSQL(int paramInt)
  {
    return sqlException(Error.error(paramInt));
  }
  
  public static SQLException sqlException(int paramInt, String paramString)
  {
    return sqlException(Error.error(paramInt, paramString));
  }
  
  public static SQLException sqlException(int paramInt, String paramString, Throwable paramThrowable)
  {
    return sqlException(Error.error(paramInt, paramString), paramThrowable);
  }
  
  public static SQLException sqlException(int paramInt1, int paramInt2)
  {
    return sqlException(Error.error(paramInt1, paramInt2));
  }
  
  static SQLException sqlException(int paramInt1, int paramInt2, Object[] paramArrayOfObject)
  {
  ...
  static SQLException notSupported()
  {
    ...
    return new SQLFeatureNotSupportedException(localHsqlException.getMessage(), localHsqlException.getSQLState(), 64036);
  }
  ...
  public static SQLException sqlException(String paramString1, String paramString2, int paramInt, Throwable paramThrowable)
  {
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\jdbc\JDBCUtil.class
