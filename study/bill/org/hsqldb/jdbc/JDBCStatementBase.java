...
class JDBCStatementBase
{
    ...
    throws SQLException
  {
    ...
    while (localResult.getChainedResult() != null)
    {
      ...
      {
        SQLWarning localSQLWarning = JDBCUtil.sqlWarning(localResult);
    ...
    throws SQLException
  {
    ...
    if ((localJDBCResultSet == null) && (this.resultOut.getStatementType() == 2)) {
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\org\hsqldb\jdbc\JDBCStatementBase.class
