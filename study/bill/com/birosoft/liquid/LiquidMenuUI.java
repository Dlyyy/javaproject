...
/*     */ 
/*     */ 
/*  76 */   private static boolean crossMenuMnemonic = true;
/*     */   
/*     */   public static ComponentUI createUI(JComponent x)
/*     */   {
/*  80 */     return new LiquidMenuUI();
/*     */   }
/*     */   
...
/*     */   {
/* 190 */     return new MouseInputHandler();
/*     */   }
/*     */   
...
/*     */   {
/* 209 */     return new PropertyChangeHandler(null);
/*     */   }
/*     */   
...
/*     */   {
/* 240 */     return new MenuDragMouseHandler(null);
/*     */   }
/*     */   
/*     */   protected MenuKeyListener createMenuKeyListener(JComponent c)
/*     */   {
/* 245 */     return new MenuKeyHandler(null);
/*     */   }
/*     */   
...
/*     */     {
/* 286 */       if (!LiquidMenuUI.crossMenuMnemonic)
/*     */       {
...
/* 299 */         if ((cnt != null) && ((cnt instanceof JMenuBar)))
/*     */         {
/*     */ 
/*     */ 
/*     */ 
/* 304 */           MenuElement[] subElements = this.menu.getPopupMenu().getSubElements();
/* 305 */           MenuElement[] me; if (subElements.length > 0)
/*     */           {
/* 307 */             MenuElement[] me = new MenuElement[4];
...
/* 324 */         if ((path.length > 0) && (path[(path.length - 1)] == this.menu))
/*     */         {
...
/* 337 */     PropertyChangeHandler(LiquidMenuUI.1 x1) { this(); }
/*     */     
...
/*     */       {
/* 344 */         LiquidMenuUI.this.updateMnemonicBinding();
/*     */       }
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 377 */       JMenu menu = (JMenu)LiquidMenuUI.this.menuItem;
...
/* 390 */           if ((cnt != null) && ((cnt instanceof JMenuBar)))
/*     */           {
...
/* 401 */       if ((selectedPath.length > 0) && (selectedPath[(selectedPath.length - 1)] != menu.getPopupMenu()))
/*     */       {
/*     */ 
...
/*     */         }
/*     */         else {
/* 409 */           LiquidMenuUI.this.setupPostTimer(menu);
/*     */         }
/*     */       }
/*     */     }
/*     */     
...
/*     */     {
/* 422 */       JMenu menu = (JMenu)LiquidMenuUI.this.menuItem;
...
/*     */     {
/* 441 */       JMenu menu = (JMenu)LiquidMenuUI.this.menuItem;
...
/*     */       {
/* 451 */         if ((selectedPath.length <= 0) || (selectedPath[(selectedPath.length - 1)] != menu.getPopupMenu()))
/*     */         {
/* 453 */           if (menu.getDelay() == 0)
/*     */           {
/* 455 */             LiquidMenuUI.appendPath(LiquidMenuUI.this.getPath(), menu.getPopupMenu());
/*     */           }
/*     */           else {
/* 458 */             manager.setSelectedPath(LiquidMenuUI.this.getPath());
/* 459 */             LiquidMenuUI.this.setupPostTimer(menu);
/*     */           }
/*     */           
/*     */         }
/*     */       }
/* 464 */       else if ((selectedPath.length > 0) && (selectedPath[0] == menu.getParent()))
/*     */       {
...
/*     */     {
/* 480 */       JMenu menu = (JMenu)LiquidMenuUI.this.menuItem;
...
/*     */     {
/* 494 */       JMenu menu = (JMenu)LiquidMenuUI.this.menuItem;
...
/* 504 */     MenuHandler(LiquidMenuUI.1 x0) { this(); }
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/* 530 */     public boolean isSelected = false;
...
/* 544 */     MenuDragMouseHandler(LiquidMenuUI.1 x1) { this(); }
/*     */     
...
/* 551 */       if (!LiquidMenuUI.this.menuItem.isEnabled()) {
/* 552 */         return;
/*     */       }
...
/* 558 */       if ((p.x >= 0) && (p.x < LiquidMenuUI.this.menuItem.getWidth()) && (p.y >= 0) && (p.y < LiquidMenuUI.this.menuItem.getHeight()))
/*     */       {
/* 560 */         JMenu menu = (JMenu)LiquidMenuUI.this.menuItem;
...
/* 570 */             LiquidMenuUI.this.setupPostTimer(menu);
/*     */           }
/*     */         }
...
/*     */   {
/* 591 */     MenuElement[] path = MenuSelectionManager.defaultManager().getSelectedPath();
...
/*     */     
/* 606 */     MenuKeyHandler(LiquidMenuUI.1 x1) { this(); }
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/*     */     {
/* 624 */       if (!LiquidMenuUI.crossMenuMnemonic)
/*     */       {
/* 626 */         JPopupMenu pm = LiquidMenuUI.getActivePopupMenu();
/* 627 */         if ((pm != null) && (pm != LiquidMenuUI.this.menuItem.getParent()))
/*     */         {
/* 629 */           return;
/*     */         }
/*     */       }
/*     */       
/* 633 */       int key = LiquidMenuUI.this.menuItem.getMnemonic();
/* 634 */       if (key == 0)
/* 635 */         return;
/* 636 */       MenuElement[] path = e.getPath();
/* 637 */       if (lower((char)key) == lower(e.getKeyChar()))
/*     */       {
/* 639 */         JPopupMenu popupMenu = ((JMenu)LiquidMenuUI.this.menuItem).getPopupMenu();
...
/*     */       {
/* 675 */         if (selectedPath[i] == LiquidMenuUI.this.menuItem)
/*     */         {
/* 677 */           JPopupMenu popupMenu = ((JMenu)LiquidMenuUI.this.menuItem).getPopupMenu();
...
/*     */     {
/* 739 */       return Character.toLowerCase(keyChar);
/*     */     }
/*     */     
...
/* Location:              E:\java\java学习\hutubill\lib\all.jar!\com\birosoft\liquid\LiquidMenuUI.class
